...
public class ConversationsConfiguration implements WebApplicationInitializer {
    ...
    public void onStartup(ServletContext servletContext) throws ServletException {
        ...
        ServletRegistration.Dynamic servlet = servletContext.addServlet("sakai.conversations", new DispatcherServlet(rootContext));
        servlet.addMapping("/");
