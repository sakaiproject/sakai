...
/**
 * Enumeration of all SSP data model errors.<br><br>
 *
 * <strong>Filename:</strong> SSP_DMErrorCodes.java<br><br>
 *
 * <strong>Description:</strong> Enumeration of SSP error codes<br><br>
 *
