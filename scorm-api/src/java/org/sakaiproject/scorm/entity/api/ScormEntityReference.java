...
public class ScormEntityReference extends IdEntityReference {
	...
	public static int getKeySeparatorPos(String reference) {
		...
		if (reference == null || reference.length() < firstSeparatorPos + 1 || reference.charAt(0) != '/')
			return -1;
	...
	public String toString() {
		return new StringBuffer().append(prefix).append("/").append(id).append("/").append(key).toString();
	}
