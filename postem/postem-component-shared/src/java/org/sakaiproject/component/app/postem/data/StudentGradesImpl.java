...
public class StudentGradesImpl implements StudentGrades, Comparable,
	 ...
	 * fillGrades method is used. Otherwise, the grades are formatted into a
	 * plain old table.
	 * <p>
	 ...
	 * <p>
	 * The prettier eventual solution will be to inject a default template via
	 * the controller, or possibly in the manager class (using a defaultTemplate
