...
<h:outputText style="font-weight:bold" value="#{PrivateMessagesTool.forum.title}" />                  
<h:dataTable id="privateForums" value="#{PrivateMessagesTool.pvtTopics}" var="topics"> 
  <h:column>  
    <h:commandLink action="#{PrivateMessagesTool.processPvtMsgTopic}" immediate="true">   
    <h:outputText value="#{topics.title}" /> 
    <f:param value="#{topics.title}" name="pvtMsgTopicTitle"/>
    </h:commandLink>
  </h:column>     
</h:dataTable>             
