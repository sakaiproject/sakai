...
%>
			...
			<sakai:tool_bar  rendered="#{PrivateMessagesTool.messages}">
 			...
 			<sakai:tool_bar_item value=" #{msgs.pvt_settings}" action="#{PrivateMessagesTool.processPvtMsgSettings}" rendered="#{PrivateMessagesTool.instructor || !PrivateMessagesTool.emailForwardDisabled}" />
