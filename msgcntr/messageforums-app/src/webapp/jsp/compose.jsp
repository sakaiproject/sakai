        ...
        <sakai:group_box>
          ...
          <h:dataTable 
            ...
            <h:column rendered="#{!empty MessageForumsTool.topicProxy.messageModel.attachments}">
              ...
              <sakai:doc_section>
                <h:graphicImage url="/image/excel.gif" rendered="#{attachment.attachmentType == 'application/vnd.ms-excel'}"/>
                <h:graphicImage url="/image/html.gif" rendered="#{attachment.attachmentType == 'text/html'}"/>
                <h:graphicImage url="/image/pdf.gif" rendered="#{attachment.attachmentType == 'application/pdf'}"/>
                <h:graphicImage url="/image/ppt.gif" rendered="#{attachment.attachmentType == 'application/vnd.ms-powerpoint'}"/>
                <h:graphicImage url="/image/text.gif" rendered="#{attachment.attachmentType == 'text/plain'}"/>
                <h:graphicImage url="/image/word.gif" rendered="#{attachment.attachmentType == 'application/msword'}"/>              
