    ...
    <h:form id="revise">
      <sakai:tool_bar_message value="#{msgs.cdfm_discussion_topic_settings}" />
		...
		<h:panelGroup rendered="#{! ForumTool.disableLongDesc}">
			...
			<sakai:inputRichText textareaOnly="#{PrivateMessagesTool.mobileSession}" rows="12" cols="120" id="topic_description" value="#{ForumTool.selectedTopic.topic.extendedDescription}">
