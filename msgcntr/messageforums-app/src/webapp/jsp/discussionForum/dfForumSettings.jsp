      ...
      <sakai:script contextBase="/sakai-jsf-resource" path="/hideDivision/hideDivision.js"/>
        <sakai:tool_bar_message value="#{msgs.cdfm_discussion_forum_settings}" />
 			 <div class="instruction">
  			    <h:outputText id="instruction"  value="#{msgs.cdfm_discussion_forum_settings_instruction}  #{msgs.cdfm_info_required_sign}"/>
			 </div>
        <p class="shorttext">
			<h:panelGrid columns="3">
				...
				<h:panelGroup/>
				<h:panelGroup><h:outputLabel id="outputLabel1" for="forum_shortDescription"  value="#{msgs.cdfm_forum_shortDescription}"/>	</h:panelGroup>
				<h:panelGroup><h:inputTextarea rows="5" cols="80" id="forum_shortDescription"  value="#{ForumTool.selectedForum.forum.shortDescription}"/></h:panelGroup>
				
				<h:panelGroup/>
				<h:panelGroup><h:outputLabel id="outputLabel2" for="forum_fullDescription"  value="#{msgs.cdfm_forum_fullDescription}"/>	</h:panelGroup>
				<h:panelGroup><h:inputTextarea rows="5" cols="80" id="forum_fullDescription"  value="#{ForumTool.selectedForum.forum.extendedDescription}"/></h:panelGroup>
      		</h:panelGrid>
		</p>
       ...
       <h4><h:outputText  value="#{msgs.cdfm_forum_posting}"/></h4>
        <p class="shorttext">
			<h:panelGrid columns="2">
				...
				<h:panelGroup>
					<h:selectOneRadio id="forum_posting"  value="#{ForumTool.selectedForum.forum.locked}">
