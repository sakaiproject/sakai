	...
	<sakai:view toolCssHref="/messageforums-tool/css/msgcntr.css">
		<h:form id="msgForum" styleClass="specialLink">
			...
			<f:subview id="wordCountView">
				<span style="margin-left:1em"><img src="/library/image/silk/table_add.png" alt="#{msgs.cdfm_message_count}" />&nbsp;<h:outputText value="#{msgs.cdfm_message_count}" />:&nbsp;<span id="counttotal"> </span></span>
			</f:subview>
