	      ...
	      <h4>
			...
			<h:panelGrid columns="1" columnClasses="longtext,checkbox">
              <h:panelGroup>
               ...
               <h:panelGroup id="openDateSpan" styleClass="indnt2" style="display: #{ForumTool.selectedForum.availabilityRestricted ? '' : 'none'}">
              	...
              	<h:panelGroup id="closeDateSpan" styleClass="indnt2" style="display: #{ForumTool.selectedForum.availabilityRestricted ? '' : 'none'}">
