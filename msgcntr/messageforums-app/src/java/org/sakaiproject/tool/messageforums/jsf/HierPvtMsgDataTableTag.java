...
public class HierPvtMsgDataTableTag extends UIComponentELTag 
{
	...
	protected void setProperties(UIComponent component) {
		...
		if (footerClass != null) {
			if (isEL(footerClass)) {
				ValueExpression vb = application.getExpressionFactory().createValueExpression(context.getELContext(), footerClass, Object.class);
				data.setValueExpression("footerClass", vb);
			} else {
		...
		if (frame != null) {
			if (isEL(frame)) {
				ValueExpression vb = application.getExpressionFactory().createValueExpression(context.getELContext(), frame, Object.class);
				data.setValueExpression("frame", vb);
			} else {
		...
		if (headerClass != null) {
			if (isEL(headerClass)) {
				ValueExpression vb = application.getExpressionFactory().createValueExpression(context.getELContext(), headerClass, Object.class);
				data.setValueExpression("headerClass", vb);
			} else {
		...
		if (lang != null) {
			if (isEL(lang)) {
				ValueExpression vb = application.getExpressionFactory().createValueExpression(context.getELContext(), lang, Object.class);
				data.setValueExpression("lang", vb);
			} else {
