  ...
  { 
	  ...
	  { 
		  ...
		  { 
			  ...
			  if(!DEFAULT_GB_ITEM.equalsIgnoreCase(changeAssign)) {
				  String gradebookUid = ToolManager.getCurrentPlacement().getContext();
				  ...
				  setUpGradeInformation(gradebookUid, changeAssign, studentId);
			  } else {
...
//		setErrorMessage(getResourceBundleString(STATE_INCONSISTENT));
    ...
    {   
        ...
        Long gbItemId = gradebookService.getAssignment(gradebookUuid, selectedAssign).getId();
