...
public class MessageForumsUserMessageImpl extends MutableEntityImpl {
      
  private String typeUuid;

  // foreign keys for hibernate
  private MessageForumsUser user; 
  ...
  public MessageForumsUser getUser()
  {
    return user;
  }

  public void setUser(MessageForumsUser user)
  {
    this.user = user;
  }
