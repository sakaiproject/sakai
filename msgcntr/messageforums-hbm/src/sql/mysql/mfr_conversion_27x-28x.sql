...
alter table MFR_AREA_T modify (AVAILABILITY bit NOT NULL DEFAULT '1'));
...
alter table MFR_OPEN_FORUM_T modify (AVAILABILITY_RESTRICTED bit NOT NULL DEFAULT '0'));

alter table MFR_OPEN_FORUM_T add (AVAILABILITY bit);
update MFR_OPEN_FORUM_T set AVAILABILITY=1 where AVAILABILITY is NULL;
alter table MFR_OPEN_FORUM_T modify (AVAILABILITY bit NOT NULL DEFAULT '1'));
...
alter table MFR_TOPIC_T modify (AVAILABILITY_RESTRICTED bit NOT NULL DEFAULT '0'));

alter table MFR_TOPIC_T add (AVAILABILITY bit);
update MFR_TOPIC_T set AVAILABILITY=1 where AVAILABILITY is NULL;
alter table MFR_TOPIC_T modify (AVAILABILITY bit NOT NULL DEFAULT '1'));
