...
alter table MFR_PERMISSION_LEVEL_T drop constraint FKDAC5B3EF2AFBA652;
alter table MFR_PERMISSION_LEVEL_T drop constraint FKDAC5B3EF6785AF85;
alter table MFR_PERMISSION_LEVEL_T drop constraint FKDAC5B3EFC6FDB1CF;
...
alter table MFR_TOPIC_T add constraint FK863DC0BEB88980FA foreign key (ACTOR_PERMISSIONS) references MFR_ACTOR_PERMISSIONS_T;
...
alter table MFR_PERMISSION_LEVEL_T add constraint FKDAC5B3EF2AFBA652 foreign key (t_surrogateKey) references MFR_TOPIC_T;
alter table MFR_PERMISSION_LEVEL_T add constraint FKDAC5B3EF6785AF85 foreign key (a_surrogateKey) references MFR_AREA_T;
alter table MFR_PERMISSION_LEVEL_T add constraint FKDAC5B3EFC6FDB1CF foreign key (of_surrogateKey) references MFR_OPEN_FORUM_T;
...
alter table MFR_OPEN_FORUM_T add constraint FKC1760847B88980FA foreign key (ACTOR_PERMISSIONS) references MFR_ACTOR_PERMISSIONS_T;
