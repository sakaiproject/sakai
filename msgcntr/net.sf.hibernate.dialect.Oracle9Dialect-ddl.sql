...
drop table MFR_AP_ACCESSORS_T cascade constraints;
drop table MFR_AP_MODERATORS_T cascade constraints;
drop table MFR_TOPIC_T cascade constraints;
drop table MFR_MESSAGE_PERMISSIONS_T cascade constraints;
drop table MFR_PERMISSION_LEVEL_T cascade constraints;
drop table MFR_AP_CONTRIBUTORS_T cascade constraints;
...
drop table MFR_ACTOR_PERMISSIONS_T cascade constraints;
drop table MFR_MEMBERSHIP_ITEM_T cascade constraints;
drop table MFR_CONTROL_PERMISSIONS_T cascade constraints;
...
drop sequence MFR_MESSAGE_PERMISSIONS_S;
drop sequence MFR_CONTROL_PERMISSIONS_S;
drop sequence MFR_DATE_RESTRICTIONS_S;
drop sequence MFR_UNREAD_STATUS_S;
drop sequence MFR_ACTOR_PERMISSIONS_S;
...
create table MFR_PERMISSION_LEVEL_T (
   ...
   POST_GRADES number(1,0) not null,
