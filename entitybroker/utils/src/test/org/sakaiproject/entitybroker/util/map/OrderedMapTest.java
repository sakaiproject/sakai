 ...
 * $Id$
 * $URL$
 * OrderedMapTest.java - entity-broker - Aug 15, 2008 5:08:59 PM - azeckoski
 **************************************************************************
...
/**
 * testing the ordered map
 * 
 * @author Aaron Zeckoski (azeckoski @ gmail.com)
 */
public class OrderedMapTest extends TestCase {

    private OrderedMap<String, String> m1 = null;

    @Override
    protected void setUp() throws Exception {
        m1 = new OrderedMap<String, String>();
        m1.put("AAA", "aaronz");
        m1.put("BBB", "beckyz");
        m1.put("CCC", "cat");
    }
