...
public class TestData {
    ...
    public static String REF1 = EntityReference.SEPARATOR + PREFIX1 + EntityReference.SEPARATOR + IDS1[0];
    public static String URL1 = SERVER_URL + DIRECT + REF1;
    public static String REF1_1 = EntityReference.SEPARATOR + PREFIX1 + EntityReference.SEPARATOR + IDS1[1];
    public static String REF1_INVALID = EntityReference.SEPARATOR + PREFIX1 + EntityReference.SEPARATOR + "XXXXXX";
    public static String REF1_INVALID_URL = SERVER_URL + DIRECT + REF1_INVALID;
    ...
    public static String REF3A = EntityReference.SEPARATOR + PREFIX3 + EntityReference.SEPARATOR + IDS3[0];
    ...
    public static String REF3B = EntityReference.SEPARATOR + PREFIX3 + EntityReference.SEPARATOR + IDS3[1];
    ...
    public static String REF4 = EntityReference.SEPARATOR + PREFIX4 + EntityReference.SEPARATOR + IDS4[0];
    public static String ENTITY_URL4_JSONP = REF4 + "." + Formats.JSONP;
    public static String REF4_two = EntityReference.SEPARATOR + PREFIX4 + EntityReference.SEPARATOR + IDS4[1];
    public static String REF4_3 = EntityReference.SEPARATOR + PREFIX4 + EntityReference.SEPARATOR + IDS4[2];
    ...
    public static String REF5 = EntityReference.SEPARATOR + PREFIX5 + EntityReference.SEPARATOR + IDS5[0];
    public static String REF5_2 = EntityReference.SEPARATOR + PREFIX5 + EntityReference.SEPARATOR + IDS5[1];
    ...
    public static String REF6 = EntityReference.SEPARATOR + PREFIX6 + EntityReference.SEPARATOR + IDS6[0];
    ...
    public static String REF6_2 = EntityReference.SEPARATOR + PREFIX6 + EntityReference.SEPARATOR + IDS6[1];
    public static String REF6_3 = EntityReference.SEPARATOR + PREFIX6 + EntityReference.SEPARATOR + IDS6[2];
    public static String REF6_4 = EntityReference.SEPARATOR + PREFIX6 + EntityReference.SEPARATOR + IDS6[3];

    public static String PREFIX7 = "describe-prefix";
    public static String[] IDS7 = new String[]{"seven", "7"};
    public static String REF7 = EntityReference.SEPARATOR + PREFIX7 + EntityReference.SEPARATOR + IDS7[0];
    public static String REF7_2 = EntityReference.SEPARATOR + PREFIX7 + EntityReference.SEPARATOR + IDS7[1];

    public static String PREFIX8 = "custom";
    public static String[] IDS8 = new String[]{"eight", "8"};
    public static String REF8 = EntityReference.SEPARATOR + PREFIX8 + EntityReference.SEPARATOR + IDS8[0];
    public static String REF8_2 = EntityReference.SEPARATOR + PREFIX8 + EntityReference.SEPARATOR + IDS8[1];

    public static String PREFIX9 = "unregPrefix9";
    public static String[] IDS9 = new String[]{"ninety", "9and1"};
    public static String REF9 = EntityReference.SEPARATOR + PREFIX9 + EntityReference.SEPARATOR + IDS9[0];
    ...
    public static String REFA = EntityReference.SEPARATOR + PREFIXA + EntityReference.SEPARATOR + IDSA[0];
    public static String REFA_2 = EntityReference.SEPARATOR + PREFIXA + EntityReference.SEPARATOR + IDSA[1];
    ...
    public static String REFA1 = EntityReference.SEPARATOR + PREFIXA1 + EntityReference.SEPARATOR + IDSA1[0];
    public static String REFA1_2 = EntityReference.SEPARATOR + PREFIXA1 + EntityReference.SEPARATOR + IDSA1[1];
    ...
    public static String REFA2 = EntityReference.SEPARATOR + PREFIXA2 + EntityReference.SEPARATOR + IDSA2[0];
    public static String REFA2_2 = EntityReference.SEPARATOR + PREFIXA2 + EntityReference.SEPARATOR + IDSA2[1];
    ...
    public static String REFA3 = EntityReference.SEPARATOR + PREFIXA3 + EntityReference.SEPARATOR + IDSA3[0];
    public static String REFA3_2 = EntityReference.SEPARATOR + PREFIXA3 + EntityReference.SEPARATOR + IDSA3[1];
    ...
    public static String REFU1 = EntityReference.SEPARATOR + PREFIXU1 + EntityReference.SEPARATOR + IDSU1[0];
    public static String REFU1_2 = EntityReference.SEPARATOR + PREFIXU1 + EntityReference.SEPARATOR + IDSU1[1];
    ...
    public static String REFU2 = EntityReference.SEPARATOR + PREFIXU2 + EntityReference.SEPARATOR + IDSU2[0];
    public static String REFU2_2 = EntityReference.SEPARATOR + PREFIXU2 + EntityReference.SEPARATOR + IDSU2[1];
    ...
    public static String REFU3 = EntityReference.SEPARATOR + PREFIXU3 + EntityReference.SEPARATOR + IDSU3[0];
    public static String REFU3_2 = EntityReference.SEPARATOR + PREFIXU3 + EntityReference.SEPARATOR + IDSU3[1];

    public static String PREFIXT1 = "tagging";
    public static String[] IDST1 = new String[]{"tag111", "tag222", "tag333"};
    public static String REFT1 = EntityReference.SEPARATOR + PREFIXT1 + EntityReference.SEPARATOR + IDST1[0];
    public static String REFT1_2 = EntityReference.SEPARATOR + PREFIXT1 + EntityReference.SEPARATOR + IDST1[1];
    public static String REFT1_3 = EntityReference.SEPARATOR + PREFIXT1 + EntityReference.SEPARATOR + IDST1[2];

    public static String PREFIXB1 = "browse1";
    public static String[] IDSB1 = new String[]{"CCC1", "BBB2", "AAA3"};
    public static String REFB1 = EntityReference.SEPARATOR + PREFIXB1 + EntityReference.SEPARATOR + IDSB1[0];
    public static String REFB1_2 = EntityReference.SEPARATOR + PREFIXB1 + EntityReference.SEPARATOR + IDSB1[1];
    public static String REFB1_3 = EntityReference.SEPARATOR + PREFIXB1 + EntityReference.SEPARATOR + IDSB1[2];

    public static String PREFIXB2 = "browse-search";
    public static String[] IDSB2 = new String[]{"sdf233", "234ess", "zzz"};
    public static String REFB2 = EntityReference.SEPARATOR + PREFIXB2 + EntityReference.SEPARATOR + IDSB2[0];
    public static String REFB2_2 = EntityReference.SEPARATOR + PREFIXB2 + EntityReference.SEPARATOR + IDSB2[1];
    public static String REFB2_3 = EntityReference.SEPARATOR + PREFIXB2 + EntityReference.SEPARATOR + IDSB2[2];

    public static String PREFIXS1 = "serialize";
    public static String[] IDSS1 = new String[]{"AZ", "BZ", "CZ"};
    public static String REFS1 = EntityReference.SEPARATOR + PREFIXS1 + EntityReference.SEPARATOR + IDSS1[0];
    public static String REFS1_2 = EntityReference.SEPARATOR + PREFIXS1 + EntityReference.SEPARATOR + IDSS1[1];
    public static String REFS1_3 = EntityReference.SEPARATOR + PREFIXS1 + EntityReference.SEPARATOR + IDSS1[2];
     ...
     */
    public TestData(EntityProviderManager entityProviderManager) {
        entityProviderManager.registerEntityProvider(entityProvider1);
        entityProviderManager.registerEntityProvider(entityProvider1T);
        entityProviderManager.registerEntityProvider(entityProvider2);
        entityProviderManager.registerEntityProvider(entityProvider3);
        entityProviderManager.registerEntityProvider(entityProvider4);
        entityProviderManager.registerEntityProvider(entityProvider5);
        entityProviderManager.registerEntityProvider(entityProvider6);
        entityProviderManager.registerEntityProvider(entityProvider7);
        entityProviderManager.registerEntityProvider(entityProvider8);
        entityProviderManager.registerEntityProvider(entityProviderA);
        entityProviderManager.registerEntityProvider(entityProviderA1);
        entityProviderManager.registerEntityProvider(entityProviderA2);
        entityProviderManager.registerEntityProvider(entityProviderA3);
        entityProviderManager.registerEntityProvider(entityProviderU1);
        entityProviderManager.registerEntityProvider(entityProviderU2);
        entityProviderManager.registerEntityProvider(entityProviderU3);
        entityProviderManager.registerEntityProvider(entityProviderTag);
        entityProviderManager.registerEntityProvider(entityProviderB1);
        entityProviderManager.registerEntityProvider(entityProviderB2);
        entityProviderManager.registerEntityProvider(entityProviderS1);
    }
