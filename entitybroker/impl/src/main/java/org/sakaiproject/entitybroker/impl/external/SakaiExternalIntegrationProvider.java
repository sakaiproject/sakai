 ...
 * this combines with the implementation of {@link DeveloperHelperService}
 ...
 */
@Slf4j
public class SakaiExternalIntegrationProvider implements ExternalIntegrationProvider, ApplicationContextAware {
    ...
    public <T> T findService(Class<T> type) {
        try {
            ...
            log.warn("Failed to find bean of type {} in spring context, {}", type.getName(), e.toString());
        }
        return null;
    }
    ...
    public void registerStatement(String prefix, String actorEmail, String verbStr, String objectURI, Boolean resultSuccess, Float resultScaledScore) {
        ...
        if (resultSuccess != null && resultScaledScore != null) {
            statement = new LRS_Statement(actorEmail, verbStr, objectURI, resultSuccess, resultScaledScore);
        } else {
