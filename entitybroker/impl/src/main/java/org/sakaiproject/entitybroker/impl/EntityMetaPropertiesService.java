...
import org.sakaiproject.entitybroker.repository.EntityPropertyRepository;
   ...
   public List<String> findEntityRefs(String[] prefixes, String[] name, String[] searchValue,
      ...
      if (! prefixList.isEmpty()) {
         ...
         if (! prefixList.isEmpty()) {
            ...
            List<String> refs = entityPropertyRepository.findDistinctEntityRefs(props, values, comparisons, relations);
            results.addAll(refs);
         }
      }
      return results;
   ...
   public Map<String, String> getProperties(String reference) {
      ...
      if (ref != null) {
         ...
         if (provider != null) {
            ...
            List<EntityProperty> properties = entityPropertyRepository.findByEntityRef(reference);
   ...
   public String getPropertyValue(String reference, String name) {
      ...
      if (ref != null) {
         ...
         if (provider != null) {
            ...
            List<EntityProperty> properties = entityPropertyRepository.findByEntityRefAndPropertyName(reference, name);
         ...
         if (provider != null) {
            ...
            if (value == null) {
               ...
               if (name != null && !name.isEmpty()) {
                  entityPropertyRepository.deleteByEntityRefAndPropertyName(reference, name);
               } else {
                  entityPropertyRepository.deleteByEntityRef(reference);
               }
            } else {
               ...
               if (properties.isEmpty()) {
                  // make new one
                  entityPropertyRepository.save(new EntityProperty(null, reference, ref.getPrefix(), name, value));
               } else {
                  // update existing one
                  EntityProperty property = properties.get(0);
                  property.setPropertyValue(value);
                  entityPropertyRepository.save(property);
               }
            }
         }
      }
