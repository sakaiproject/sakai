...
public class EntityRedirectsManagerTest extends TestCase {
   ...
   /**
    * Test method for {@link org.sakaiproject.entitybroker.impl.EntityRedirectsManager#checkForTemplateMatch(org.sakaiproject.entitybroker.entityprovider.EntityProvider, java.lang.String)}.
    */
   public void testCheckForTemplateMatch() {
      ...
      targetURL = entityRedirectsManager.checkForTemplateMatch(td.entityProviderU1, TestData.SPACEU1 + "/xml/123");
      assertNotNull(targetURL);
      assertEquals(TemplateParseUtil.DIRECT_PREFIX+TestData.SPACEU1+"/123.xml", targetURL);

      targetURL = entityRedirectsManager.checkForTemplateMatch(td.entityProviderU1, TestData.SPACEU1 + "/going/nowhere");
      assertNotNull(targetURL);
      ...
      targetURL = entityRedirectsManager.checkForTemplateMatch(td.entityProviderU2, TestData.SPACEU2 + "/123/AZ/go/junk");
      assertNotNull(targetURL);
      assertEquals(TemplateParseUtil.DIRECT_PREFIX+"/other/stuff?prefix="+TestData.PREFIXU2+"&id=123", targetURL);

      targetURL = entityRedirectsManager.checkForTemplateMatch(td.entityProviderU2, TestData.SPACEU2 + "/xml/123/junk");
      assertNotNull(targetURL);
      ...
      targetURL = entityRedirectsManager.checkForTemplateMatch(td.entityProviderU3, TestData.SPACEU3 + "/123/AZ/go/junk");
      assertNotNull(targetURL);
      assertEquals("http://caret.cam.ac.uk/?prefix="+TestData.PREFIXU3+"&thing=AZ", targetURL);

      targetURL = entityRedirectsManager.checkForTemplateMatch(td.entityProviderU3, TestData.SPACEU3 + "/xml/123/junk");
      assertNotNull(targetURL);
      assertEquals(TemplateParseUtil.DIRECT_PREFIX+TestData.SPACEU3+"/123.xml", targetURL);

      // test non-matching
      targetURL = entityRedirectsManager.checkForTemplateMatch(td.entityProvider4, TestData.SPACE4 + "/123");
      assertNull(targetURL);
   }
