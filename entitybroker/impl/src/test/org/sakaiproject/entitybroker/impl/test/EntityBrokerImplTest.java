...
public class EntityBrokerImplTest extends AbstractTransactionalSpringContextTests {
    ...
    protected void onSetUpBeforeTransaction() throws Exception {
        ...
        dao = (EntityBrokerDao) applicationContext.getBean("org.sakaiproject.entitybroker.dao.EntityBrokerDao");
        if (dao == null) {
...
//      assertEquals(new Long(1), tdp.pNode1.getId());
    ...
    /**
     * Test method for {@link org.sakaiproject.entitybroker.impl.EntityBrokerImpl#entityExists(java.lang.String)}.
     */
    ...
    /**
     * Test method for {@link org.sakaiproject.entitybroker.impl.EntityBrokerImpl#getEntityURL(java.lang.String)}.
     */
    ...
    /**
     * Test method for {@link org.sakaiproject.entitybroker.impl.EntityBrokerImpl#getRegisteredPrefixes()}.
     */
    ...
    /**
     * Test method for {@link org.sakaiproject.entitybroker.impl.EntityBrokerImpl#fireEvent(java.lang.String, java.lang.String)}.
     */
    ...
    /**
     * Test method for {@link org.sakaiproject.entitybroker.impl.EntityBrokerImpl#parseReference(java.lang.String)}.
     */
    ...
    /**
     * Test method for {@link org.sakaiproject.entitybroker.impl.EntityBrokerImpl#fetchEntity(java.lang.String)}.
     */
    ...
    /**
     * Test method for {@link org.sakaiproject.entitybroker.impl.EntityBrokerImpl#findEntityRefs(java.lang.String[], java.lang.String[], java.lang.String[], boolean)}.
     */
    public void testFindEntityRefs() {
        List<String> l = null;

        // test search with limit by prefix
        l = entityBroker.findEntityRefs(new String[] {TestData.PREFIX1}, null, null, true);
        assertNotNull(l);
        assertEquals(2, l.size());
        assertTrue(l.contains( TestData.REF1) );
        assertTrue(l.contains( TestData.REF1_1) );
        ...
        l = entityBroker.findEntityRefs(new String[] {TestData.PREFIX2, TestData.PREFIX3}, null, null, true);
        assertNotNull(l);
        assertEquals(2, l.size());
        assertTrue(l.contains( TestData.REF2) );
        assertTrue(l.contains( TestData.REF3) );

        // test searching by names
        l = entityBroker.findEntityRefs(null, new String[] {TestData.PROPERTY_NAME1}, null, true);
        assertNotNull(l);
        assertEquals(1, l.size());
        assertTrue(l.contains( TestData.REF1) );

        l = entityBroker.findEntityRefs(null, new String[] {TestData.PROPERTY_NAME1B}, null, true);
        assertNotNull(l);
        ...
        l = entityBroker.findEntityRefs(null, new String[] {TestData.INVALID_REF}, null, true);
        assertNotNull(l);
        assertEquals(0, l.size());

        // test searching with multiple names
        l = entityBroker.findEntityRefs(null, new String[] {TestData.PROPERTY_NAME1, TestData.PROPERTY_NAME3B}, null, true);
        assertNotNull(l);
        assertEquals(2, l.size());
        assertTrue(l.contains( TestData.REF1) );
        assertTrue(l.contains( TestData.REF3) );
        ...
        l = entityBroker.findEntityRefs(null, new String[] {TestData.PROPERTY_NAME3B}, new String[] {TestData.PROPERTY_VALUE3B}, true);
        assertNotNull(l);
        assertEquals(1, l.size());
        assertTrue(l.contains( TestData.REF3) );

        // test search limit by values (exact match)
        l = entityBroker.findEntityRefs(null, new String[] {TestData.PROPERTY_NAME1B}, new String[] {TestData.PROPERTY_VALUE1B}, true);
        assertNotNull(l);
        assertEquals(2, l.size());
        assertTrue(l.contains( TestData.REF1) );
        assertTrue(l.contains( TestData.REF2) );

        // test search limit by values (like match)
        l = entityBroker.findEntityRefs(null, new String[] {TestData.PROPERTY_NAME1B}, new String[] {TestData.PROPERTY_VALUE1B}, false);
        assertNotNull(l);
        assertEquals(3, l.size());
        assertTrue(l.contains( TestData.REF1) );
        assertTrue(l.contains( TestData.REF2) );
        ...
        try {
            l = entityBroker.findEntityRefs(null, new String[] {}, new String[] {TestData.PROPERTY_VALUE3B}, true);
            fail("Should have thrown exception");
        } catch (IllegalArgumentException e) {
            assertNotNull(e.getMessage());
        }
        ...
        try {
            l = entityBroker.findEntityRefs(null, null, new String[] {TestData.PROPERTY_VALUE3B}, true);
            fail("Should have thrown exception");
        } catch (IllegalArgumentException e) {
            assertNotNull(e.getMessage());
        }

        // test multiple names and values
        l = entityBroker.findEntityRefs(null, new String[] {TestData.PROPERTY_NAME1, TestData.PROPERTY_NAME2}, 
                new String[] {TestData.PROPERTY_VALUE1, TestData.PROPERTY_VALUE2}, true);
        assertNotNull(l);
        assertEquals(2, l.size());
        assertTrue(l.contains( TestData.REF1) );
        assertTrue(l.contains( TestData.REF2) );
        ...
        try {
            l = entityBroker.findEntityRefs(null, new String[] {TestData.PROPERTY_NAME1, TestData.PROPERTY_NAME2}, 
                    new String[] {TestData.PROPERTY_VALUE1}, true);
            fail("Should have thrown exception");
        } catch (IllegalArgumentException e) {
            assertNotNull(e.getMessage());
        }
        ...
        try {
            l = entityBroker.findEntityRefs(null, new String[] {TestData.PROPERTY_NAME1}, 
                    new String[] {TestData.PROPERTY_VALUE1, TestData.PROPERTY_VALUE2}, true);
            fail("Should have thrown exception");
        } catch (IllegalArgumentException e) {
            assertNotNull(e.getMessage());
        ...
        // test search limit by prefix and value
        l = entityBroker.findEntityRefs(new String[] {TestData.PREFIX1}, 
                new String[] {TestData.PROPERTY_NAME1, TestData.PROPERTY_NAME2}, 
                new String[] {TestData.PROPERTY_VALUE1, TestData.PROPERTY_VALUE2}, true);
        assertNotNull(l);
        assertEquals(1, l.size());
        assertTrue(l.contains( TestData.REF1) );

        // test search with all null or empty fields fail
        try {
            l = entityBroker.findEntityRefs(null, null, null, false);
            fail("Should have thrown exception");
        } catch (IllegalArgumentException e) {
            assertNotNull(e.getMessage());
        }
    ...
    /**
     * Test method for {@link org.sakaiproject.entitybroker.impl.EntityBrokerImpl#getProperties(java.lang.String)}.
     */
    public void testGetProperties() {
        ...
        assertTrue(m.containsKey(TestData.PROPERTY_NAME1));
        assertTrue(m.containsKey(TestData.PROPERTY_NAME1B));
        assertTrue(m.containsKey(TestData.PROPERTY_NAME1C));

        m = entityBroker.getProperties(TestData.REF1_1);
        assertNotNull(m);
        assertEquals(1, m.size());
        assertTrue(m.containsKey(TestData.PROPERTY_NAME1_1));

        m = entityBroker.getProperties(TestData.REF3);
        assertNotNull(m);
        assertEquals(2, m.size());
        assertTrue(m.containsKey(TestData.PROPERTY_NAME3));
        assertTrue(m.containsKey(TestData.PROPERTY_NAME3B));
        // ensure large data compares correctly
        assertEquals(TestData.PROPERTY_VALUE3, m.get(TestData.PROPERTY_NAME3));
        assertEquals(TestData.PROPERTY_VALUE3B, m.get(TestData.PROPERTY_NAME3B));

        // ref with no properties should fetch none
        m = entityBroker.getProperties(TestData.REF4);
        assertNotNull(m);
    ...
    /**
     * Test method for {@link org.sakaiproject.entitybroker.impl.EntityBrokerImpl#getPropertyValue(java.lang.String, java.lang.String)}.
     */
    public void testGetPropertyValue() {
        String value = null;

        value = entityBroker.getPropertyValue(TestData.REF1, TestData.PROPERTY_NAME1);
        assertNotNull(value);
        assertEquals(TestData.PROPERTY_VALUE1, value);

        value = entityBroker.getPropertyValue(TestData.REF2, TestData.PROPERTY_NAME2);
        assertNotNull(value);
        assertEquals(TestData.PROPERTY_VALUE2, value);

        // test large value retrieval
        value = entityBroker.getPropertyValue(TestData.REF3, TestData.PROPERTY_NAME3B);
        assertNotNull(value);
        assertEquals(TestData.PROPERTY_VALUE3B, value);

        // nonexistent value property get retrieves null
        value = entityBroker.getPropertyValue(TestData.REF1, "XXXXXXXXXXXX");
        assertNull(value);

        // make sure invalid ref causes failure
        try {
            value = entityBroker.getPropertyValue(TestData.INVALID_REF, TestData.PROPERTY_NAME1);
            fail("Should have thrown exception");
        } catch (IllegalArgumentException e) {
            assertNotNull(e.getMessage());
        }
        ...
        try {
            value = entityBroker.getPropertyValue(TestData.REF1, null);
            fail("Should have thrown exception");
        } catch (IllegalArgumentException e) {
            assertNotNull(e.getMessage());
        }
        ...
        try {
            value = entityBroker.getPropertyValue(TestData.REF1, "");
            fail("Should have thrown exception");
        } catch (IllegalArgumentException e) {
            assertNotNull(e.getMessage());
        }
    ...
    /**
     * Test method for {@link org.sakaiproject.entitybroker.impl.EntityBrokerImpl#setPropertyValue(java.lang.String, java.lang.String, java.lang.String[])}.
     */
    public void testSetPropertyValue() {
        String value = null;

        // check that we can save a new property on an entity
        entityBroker.setPropertyValue(TestData.REF1, "newNameAlpha", "newValueAlpha");
        value = entityBroker.getPropertyValue(TestData.REF1, "newNameAlpha");
        assertNotNull(value);
        assertEquals("newValueAlpha", value);

        // check that we can update an existing property on an entity
        entityBroker.setPropertyValue(TestData.REF1, TestData.PROPERTY_NAME1, "AZnewValue");
        value = entityBroker.getPropertyValue(TestData.REF1, TestData.PROPERTY_NAME1);
        assertNotNull(value);
        assertNotSame(TestData.PROPERTY_VALUE1, value);        
        assertEquals("AZnewValue", value);

        // check that we can remove a property on an entity
        entityBroker.setPropertyValue(TestData.REF1, "newNameAlpha", null);
        value = entityBroker.getPropertyValue(TestData.REF1, "newNameAlpha");
        assertNull(value);

        // check that we can remove all properties on an entity
        Map<String, String> m = entityBroker.getProperties(TestData.REF1);
        assertEquals(3, m.size());
        entityBroker.setPropertyValue(TestData.REF1, null, null);
        m = entityBroker.getProperties(TestData.REF1);
