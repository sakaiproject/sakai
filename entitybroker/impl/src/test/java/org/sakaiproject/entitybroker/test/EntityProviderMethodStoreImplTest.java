...
public class EntityProviderMethodStoreImplTest {
    ...
    @Autowired private EntityProviderMethodStoreImpl entityProviderMethodStore;
    ...
    public void tearDown() {
        ...
        entityProviderMethodStore.destroy();
        td = null;
    }

    @Test
    public void testStoreCustomActions() {
        ...
        entityProviderMethodStore.storeCustomActions(TestData.PREFIXA1, actions);
        ...
        entityProviderMethodStore.storeCustomActions(TestData.PREFIX2, actions);
    ...
    public void testAddURLRedirects() {
        ...
        Assert.assertThrows(IllegalArgumentException.class, () -> entityProviderMethodStore.addURLRedirects("testing", new URLRedirect[]{valid3}));
    }
