...
public class EntityProviderManagerImplTest {
    ...
    public void testGetRegisteredEntityCapabilities() {
        Map<String, List<Class<? extends EntityProvider>>> m;
    ...
    public void testGetProvidersByCapability() {
        List<? extends EntityProvider> providers;
    ...
    public void testRegisterEntityProvider() {
        ...
        Assert.assertThrows(IllegalArgumentException.class, () -> entityProviderManager.registerEntityProvider(null));
    }
    ...
    public void testUnregisterEntityProvider() {
        ...
        Assert.assertThrows(NullPointerException.class, () -> entityProviderManager.unregisterEntityProvider(null));
    }
    ...
    public void testUnregisterEntityProviderByPrefix() {
        ...
        // test unregistering null dies horribly
        Assert.assertThrows(NullPointerException.class, () -> entityProviderManager.unregisterEntityProviderByPrefix(null));
    }
    ...
    public void testUnregisterEntityProviderCapability() {
        ...
        Assert.assertNull(entityProviderManager.getProviderByPrefixAndCapability(TestData.PREFIX1, Taggable.class));
        ...
        // test unregistering null dies horribly
        Assert.assertThrows(IllegalArgumentException.class, () -> entityProviderManager.unregisterCapability(TestData.PREFIX3, null));
    }
    ...
    public void testRegisterListener() {
        ...
        // make sure null dies
        Assert.assertThrows(IllegalArgumentException.class, () -> entityProviderManager.registerListener(null, true));
    }
    ...
    public void testUnregisterListeners() {
        ...
        // make sure null dies
        Assert.assertThrows(IllegalArgumentException.class, () -> entityProviderManager.unregisterListener(null));
    }
