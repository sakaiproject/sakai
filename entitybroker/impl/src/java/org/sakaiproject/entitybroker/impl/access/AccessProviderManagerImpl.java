...
/** A common generic implementation class for managers of different kinds
 * of access providers.
 * 
...
public class AccessProviderManagerImpl<T> {
   ...
   private Map<String, WeakReference<T>> prefixMap = 
      new ConcurrentHashMap<String, WeakReference<T>>();
