...
/**
 * The single standard EntityProducer for all "Entities" managed by the
 * EntityBroker system. Entity objects are only created on demand and will
 * expire when unreferenced.
 * 
...
public class EntityBrokerEntityProducer implements EntityProducer {
	...
	/**
	 * <b>NOTE VERY CAREFULLY</b> - current implementation of EntityManager ignores
	 * referenceRoot! This will fail if this ever changes
	 */
	public void init() {
	...
	public boolean parseEntityReference(String reference, Reference ref) {
		...
		EntityProvider entityProvider = entityProviderManager
				.getProviderByPrefix(entityref.prefix);
		if (entityProvider != null) {
			String id = entityref instanceof IdEntityReference? ((IdEntityReference) entityref).id : null;
