...
public class EntityProviderManagerImpl implements EntityProviderManager {
   ...
   private ConcurrentMap<String, EntityProvider> prefixMap = 
      new ConcurrentHashMap<String, EntityProvider>();
   ...
   /* (non-Javadoc)
    * @see org.sakaiproject.entitybroker.entityprovider.EntityProviderManager#unregisterEntityProviderCapability(java.lang.String, java.lang.Class)
    */
    ...
    */
   protected boolean registerPrefixCapability(String prefix, Class<? extends EntityProvider> capability, EntityProvider entityProvider) {
      String key = getBiKey(prefix, capability);
