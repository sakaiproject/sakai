...
import org.sakaiproject.entitybroker.entityprovider.capabilities.PropertiesProvider;
...
public class EntityBrokerImpl implements EntityBroker, PropertiesProvider {
    ...
    public void fireEvent(String eventName, String reference) {
        ...
        Event event = eventTrackingService.newEvent(eventName, reference, 
    ...
    public List<String> findEntityRefs(String[] prefix, String[] name, String[] searchValue, boolean exactMatch) {
        ...
        if (prefix == null && name == null && searchValue == null) {
            throw new IllegalArgumentException("At least one of prefix, name, or searchValue has to be not null");
        }
        ...
        return dao.getEntityRefsForSearch(props, values, comparisons, relations);
    }
