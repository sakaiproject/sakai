...
/**
 * Finds and registers any {@link EntityProvider} implementation which also
 * implements {@link AutoRegisterEntityProvider}
 *
...
public class EntityProviderAutoRegistrar implements ApplicationContextAware {
	...
	public void setApplicationContext(ApplicationContext context) throws BeansException {
		...
		String[] autobeans = context.getBeanNamesForType(
				AutoRegisterEntityProvider.class, false, false);
		...
		for (String autobean: autobeans) {
			...
			if (register.getEntityPrefix() == null ||
					register.getEntityPrefix().equals("")) {
				// should this die here or is this error log enough? -AZ
				log.error("Could not autoregister EntityProvider because the enity prefix is null or empty string for class: " + register.getClass().getName());
			} else {
