...
public class EntityDescriptionManager {
    ...
    @Setter private EntityViewAccessProviderManager entityViewAccessProviderManager;
    @Setter private EntityProviderManager entityProviderManager;
    @Setter private EntityPropertiesService entityProperties;
    @Setter private EntityBrokerManager entityBrokerManager;
    @Setter private EntityProviderMethodStore entityProviderMethodStore;
