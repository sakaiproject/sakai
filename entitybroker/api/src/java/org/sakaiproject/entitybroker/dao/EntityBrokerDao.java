...
public interface EntityBrokerDao extends CompleteGenericDao {
    ...
    /**
     * Get a list of unique entity references for a set of search params,
     ...
     * note that the first relation is basically thrown away
     * @return a list of unique {@link String}s which represent entity references
     */
    public List<String> getEntityRefsForSearch(List<String> properties, List<String> values, List<Integer> comparisons, List<String> relations);

    /**
     * Remove properties from an entity without wasting time doing a lookup first
     * @param entityReference unique reference to an entity
     * @param name the name of the property to remove,
     * leaving this null will remove all properties
