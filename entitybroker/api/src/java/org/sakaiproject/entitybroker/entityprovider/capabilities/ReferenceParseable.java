 ...
 * An entity that does not implement this interface is assumed to deal in
 * references of type {@link IdEntityReference}.
 * <br/>
...
public interface ReferenceParseable extends EntityProvider {
	 ...
	 * {@link ParseSpecParseable} a default parse specification will be inferred
	 * for you (the entity prefix will always come first).
	 * 
