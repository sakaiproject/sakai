...
public class TestData {
    ...
    public final static String REF1 = EntityReference.SEPARATOR + PREFIX1 + EntityReference.SEPARATOR + IDS1[0];
    public final static String REF1_1 = EntityReference.SEPARATOR + PREFIX1 + EntityReference.SEPARATOR + IDS1[1];
    public final static String REF1_INVALID = EntityReference.SEPARATOR + PREFIX1 + EntityReference.SEPARATOR + "XXXXXX";
    ...
    public final static String REF3 = EntityReference.SEPARATOR + PREFIX3 + EntityReference.SEPARATOR + IDS3[0];

    public final static String PREFIX4 = "myPrefix4";
    public final static String[] IDS4 = new String[] {"4-one","4-two"};
    public final static String REF4 = EntityReference.SEPARATOR + PREFIX4 + EntityReference.SEPARATOR + IDS4[0];
    public final static String REF4_two = EntityReference.SEPARATOR + PREFIX4 + EntityReference.SEPARATOR + IDS4[1];


    public final static String PREFIX9 = "unregPrefix9";
    public final static String[] IDS9 = new String[] {"ninety","9and1"};
    public final static String REF9 = EntityReference.SEPARATOR + PREFIX9 + EntityReference.SEPARATOR + IDS9[0];
    ...
    public final static String PROPERTY_NAME1 = "prop1";
    public final static String PROPERTY_VALUE1 = "value1";

    /**
     * this name is shared by {@link #PROPERTY_NAME1B} and {@link #PROPERTY_NAME2} and {@link #PROPERTY_NAME3}
     */
    public final static String PROPERTY_NAME1B = "myprop";
    /**
     * This value is shared by {@link #PROPERTY_VALUE1B} and {@value #PROPERTY_VALUE2}
     */
    public final static String PROPERTY_VALUE1B = "applesauce";

    public final static String PROPERTY_NAME1C = "prop1C";
    /**
     * Lots of quote chars example
     */
    public final static String PROPERTY_VALUE1C = "Keep movin', movin', movin' Though they're disapprovin' Keep them dogies movin' Rawhide!";

    /**
     * associated with the same prefix as the other {@link #PROPERTY_NAME1} vars
     */
    public final static String PROPERTY_NAME1_1 = "property1_1";
    public final static String PROPERTY_VALUE1_1 = "learning is fun";

    /**
     * this name is shared by {@link #PROPERTY_NAME1B} and {@link #PROPERTY_NAME2} and {@link #PROPERTY_NAME3}
     */
    public final static String PROPERTY_NAME2 = "myprop";
    /**
     * This value is shared by {@link #PROPERTY_VALUE1B} and {@value #PROPERTY_VALUE2}
     */
    public final static String PROPERTY_VALUE2 = "applesauce";

    /**
     * this name is shared by {@link #PROPERTY_NAME1B} and {@link #PROPERTY_NAME2} and {@link #PROPERTY_NAME3}
     */
    public final static String PROPERTY_NAME3 = "myprop";
    public final static String PROPERTY_VALUE3 = "my applesauce is great";

    public final static String PROPERTY_NAME3B = "superLong";
    /**
     * Long string example
     */
    public final static String PROPERTY_VALUE3B = "Futurama:: " +
    ...
    /**
     * Registered provider that implements {@link EntityProvider} and {@link Taggable},
     * this provider builds on {@link #entityProvider1}
     */
