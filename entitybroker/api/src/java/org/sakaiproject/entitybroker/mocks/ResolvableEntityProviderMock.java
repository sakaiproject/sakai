...
/**
 * Stub class to make it possible to test the {@link Resolvable} capability,
 * will perform like the actual class so it can be reliably used for testing<br/>
 * Returns {@link MyEntity} objects
 * 
 * @author Aaron Zeckoski (aaronz@vt.edu)
 */
public class ResolvableEntityProviderMock extends CoreEntityProviderMock implements CoreEntityProvider, Resolvable {
