...
/**
 * Allows a developer to create a method which will be called when specific events occur
 * by implementing this interface, this uses the Sakai event services
 * 
...
public interface EventReceiver {
	 ...
	 * {@link #receiveEvent(String, String)} will be called whenever an event occurs which
	 * has a name which begins with any of the strings this method returns,
	 * simply return empty array if you do not want to match events this way<br/>
	 * <br/>
	 ...
	 * {@link #receiveEvent(String, String)} will be called whenever an event occurs which
	 * has a resource which begins with the string this method returns,
	 * simply return empty string to match no events this way<br/>
	 * <br/>
