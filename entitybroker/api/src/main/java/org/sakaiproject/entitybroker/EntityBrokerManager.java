...
public interface EntityBrokerManager {
     ...
     * <br/>
     * <b>Note:</b> the webapp name (relative URL path) of "/direct" is hardcoded into this method,
     * and the direct access webapp must be deployed there on this server.
     * 
    ...
    Object fetchEntityObject(EntityReference ref);
    /**
