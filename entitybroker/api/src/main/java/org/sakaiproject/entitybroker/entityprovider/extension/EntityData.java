...
public class EntityData {
    ...
    @Getter private String entityId = null;
     ...
     */
    @Setter @Getter private String entityURL;
     ...
     */
    @Setter private Map<String, Object> entityProperties;
     ...
     */
    @Getter @Setter private transient boolean populated = false;

    /**
     * indicates that this is a holder and should be discarded and the data
     * rendered into the given format without it
     */
    @Setter @Getter private transient boolean dataOnly = false;
