...
public interface EntityProviderManager {
    ...
    /**
     * Resets the provider manager by clearing all registered providers and listeners.
     * This properly unregisters all providers and listeners, ensuring all cleanup operations
     * (removing custom actions, properties, URL redirects) are performed.
     * <p>
     * This is a thread-safe operation that acquires both locks and performs proper cleanup
     * before clearing the maps.
     * <p>
     * Warning: This will remove all registered entity providers and listeners. Use with caution.
     */
    void unRegistrarAllProvidersAndListeners();
}
