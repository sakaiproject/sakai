 ...
 * @author ieb
 */
public class OOXmlContentDigester extends BaseContentDigester
{
	private static Log log = LogFactory.getLog(OOXmlContentDigester.class);
	...
	{
		log.debug("Digesting with OOXmlContentDigester");
