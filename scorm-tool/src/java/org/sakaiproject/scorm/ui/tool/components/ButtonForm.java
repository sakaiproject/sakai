...
public class ButtonForm extends Form {
	...
	private IndicatingAjaxButton prevButton, nextButton, startButton, quitButton, suspendButton;
	...
	public abstract class ActivityAjaxButton extends IndicatingAjaxButton {
		private Form form;
	...
	public IndicatingAjaxButton getQuitButton() {
		return quitButton;
	}
