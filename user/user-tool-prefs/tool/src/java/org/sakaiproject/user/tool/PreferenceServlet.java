...
public class PreferenceServlet extends JsfTool {
	...
	{
		String defaultPreference="prefs_noti_title, prefs_timezone_title, prefs_lang_title, prefs_editor_title, prefs_theme_title";
		String Notification="prefs_noti_title", Timezone="prefs_timezone_title", Language="prefs_lang_title", Editor="prefs_editor_title", Theme="prefs_theme_title";
