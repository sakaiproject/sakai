...
public class SiteHandler extends WorksiteHandler
{
	...
	private static final String SAK_PROP_SHOW_VERBOSE_LABELS = "portal.trinity.siteList.verboseLabels";
	private static final boolean SAK_PROP_SHOW_VERBOSE_LABELS_DFLT = true;
	...
	public void doSite(HttpServletRequest req, HttpServletResponse res, Session session,
		...
		rcontext.put("showVerboseLabels",ServerConfigurationService.getBoolean(SAK_PROP_SHOW_VERBOSE_LABELS, SAK_PROP_SHOW_VERBOSE_LABELS_DFLT));
