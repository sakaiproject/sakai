...
public class PortalSiteHelper
{
    ...
    public List<Site> getAllSites(HttpServletRequest req, Session session,
	    ...
	    if ( ! loggedIn ) {
            	...
            	mySites = (List<Site>)SiteService.getSites(
...
*/
   ...
   protected final static String CURRENT_PLACEMENT = "sakai:ToolComponent:current.placement";
    ...
    /*
     * There must be a better way of doing this as this hard codes the services in
     * surely there should be some whay of looking up the serivce and making the 
     * getSummary part of an interface.
     * 
     * 
     * TODO: 
     * Add an interface beside EntityProducer to generate summaries
