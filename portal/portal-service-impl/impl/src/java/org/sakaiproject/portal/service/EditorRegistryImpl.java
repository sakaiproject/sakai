...
public class EditorRegistryImpl implements EditorRegistry {
	...
	public void init() {
		...
		register("ckeditor", "CKEditor", "/library/webjars/ckeditor/4.11.1/full/ckeditor.js", "/library/editor/ckeditor.launch.js",
				"var CKEDITOR_BASEPATH='/library/webjars/ckeditor/4.11.1/full/';\n");
	}
