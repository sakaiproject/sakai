...
//				}
		...
		if(this.collection)
		{
			...
			if(this.EXPANDABLE_FOLDER_NAV_SIZE_LIMIT != 0 && ("!admin".equals(siteId) || SiteService.getUserSiteId("admin").contains(siteId)) && (collection_size > this.EXPANDABLE_FOLDER_NAV_SIZE_LIMIT))
			{
				setIsTooBigNav(true);
			}
			else{
