...
public class AssignmentEventObserver implements Observer {
    ...
    public void update(Observable o, Object arg) {
        if (arg instanceof Event) {
            ...
            // recibe 2
                // filtra el del GradingServiceImpl -> /gradebook/4e4be788-a92c-44be-8a3b-414c353d25b0/2805xx/49247cae-88fe-4bf8-9e5c-e84b4a6fb989/5.0/student
                // procesa el del EventHelper -> /gradebookng/9/35/49247cae-88fe-4bf8-9e5c-e84b4a6fb989/5/OK/instructor
                    // TODO hay que ver si queremos con ese GB id obtener el uid y hacer cosas
                        // OJO si un mismo usuario está asociado a varios GBs y se cambia en 1 en tareas se va a quedar 1 , pero es q ese caso de uso no debería existir
...
System.out.println("-------------gradebookUid " + gradebookUid);
                                try {
                                    ...
                                    log.debug("Can't retrieve gradebook assignment for gradebook {} and item {}, {}", gradebookUid, itemId, anfe.getMessage()); // S2U-26 - TODO modify when SAK-49493 is done
