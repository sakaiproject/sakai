...
package org.sakaiproject.citation.search;
...
public class CitationSearchServlet extends VmServlet
{
	/**
	 * 
	 */
	...
	/** Our log (commons). */
	private static Log M_log = LogFactory.getLog(CitationSearchServlet.class);
	...
	{
        M_log.debug("CitationSearchServlet.doGet()");
        ...
        M_log.debug("CitationSearchServlet.doGet() session == " + session);
        Enumeration names = session.getAttributeNames();
        while(names.hasMoreElements())
        {
        	String name = (String) names.nextElement();
            M_log.debug("CitationSearchServlet.doGet() attr-name == " + name);
