...
public class StartPagePartStructure implements org.osid.repository.PartStructure
{
  ...
  private static StartPagePartStructure startPagePartStructure =
    new StartPagePartStructure();

  public static StartPagePartStructure getInstance()
  {
  ...
  protected StartPagePartStructure()
  {
    try
    {
      this.START_PAGE_PART_STRUCTURE_ID =
      	Managers.getIdManager().getId("123908kjh12389032hjg7682sdgu00155");
    }
    catch (Throwable t)
    {
    }
