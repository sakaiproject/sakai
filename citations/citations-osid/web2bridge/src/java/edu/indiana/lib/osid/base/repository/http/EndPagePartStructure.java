...
public class EndPagePartStructure implements org.osid.repository.PartStructure
{
  ...
  private static EndPagePartStructure endPagePartStructure =
    new EndPagePartStructure();

  public static EndPagePartStructure getInstance()
  {
  ...
  protected EndPagePartStructure()
  {
    try
    {
      this.END_PAGE_PART_STRUCTURE_ID =
      	Managers.getIdManager().getId("x323sd84h8kr98239823h543tg0982340");
    }
    catch (Throwable t)
    {
    }
