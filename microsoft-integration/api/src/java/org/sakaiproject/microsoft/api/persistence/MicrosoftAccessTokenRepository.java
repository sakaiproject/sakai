...
public interface MicrosoftAccessTokenRepository extends SerializableRepository<MicrosoftAccessToken, String> {
	public MicrosoftAccessToken findBySakaiId(String id);
}
