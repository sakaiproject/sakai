 ...
 */
package org.sakaiproject.microsoft.mediagallery;
...
@Configuration
@EnableWebMvc
@ComponentScan("org.sakaiproject.microsoft.mediagallery")
public class ThymeleafConfig implements WebMvcConfigurer, ApplicationContextAware {
	...
	@Bean
	@SessionScope
	public MediaGallerySessionBean mediaGallerySessionBean() {
		return new MediaGallerySessionBean();
	}
