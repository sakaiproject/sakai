...
package org.sakaiproject.microsoft.collaborativedocuments;
...
public class WebAppConfiguration implements WebApplicationInitializer {
	...
	public void onStartup(ServletContext servletContext) throws ServletException {
		...
		Dynamic servlet = servletContext.addServlet("microsoft.collaborativedocuments", new DispatcherServlet(rootContext));
		servlet.addMapping("/");
