...
@Configuration
@EnableWebMvc
@ComponentScan("org.sakaiproject.microsoft.collaborativedocuments")
public class ThymeleafConfig implements WebMvcConfigurer, ApplicationContextAware {
	...
	@Bean
	@SessionScope
	public CollaborativeDocumentsSessionBean collaborativeDocumentsSessionBean() {
		return new CollaborativeDocumentsSessionBean();
	}
