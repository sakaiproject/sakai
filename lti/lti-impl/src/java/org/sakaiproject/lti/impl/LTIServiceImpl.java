...
public class LTIServiceImpl implements LTIService {
	...
	private Object transferToolContentLinksDao(Long currentTool, Long newTool)
	{
		...
		String siteId = null;
		Map<String, Object> new_tool = getTool(newTool, siteId, isAdminRole);
		if ( new_tool == null ) {
			return rb.getString("error.transfer.bad.tools");
		}
	...
	private void deployStealthToolAfterTransfer(Map<String, Object> destinationTool, Long newTool) {
