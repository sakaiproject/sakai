...
public class LtiToolBeanTest {
    ...
    public void testFromMapCompleteData() {
        ...
        assertEquals("{\"lti13\":\"settings\"}", tool.getLti13Settings());
    ...
    public void testToMapCompleteData() {
        ...
        tool.setLti13Settings("{\"test\":\"settings\"}");
        ...
        assertEquals("off", result.get("lti13"));
        ...
        assertEquals("{\"test\":\"settings\"}", result.get("lti13_settings"));
