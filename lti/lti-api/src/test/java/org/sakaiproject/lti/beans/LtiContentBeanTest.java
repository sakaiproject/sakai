...
public class LtiContentBeanTest {
    ...
    public void testDatabaseNumberTypeRobustness() {
        ...
        mapWithDatabaseTypes.put("lti13", Byte.valueOf((byte)1)); // Byte
    ...
    public void testStringNumberRobustness() {
        ...
        mapWithStringNumbers.put("lti13", "1"); // Single digit string
    ...
    public void testDecimalStringHandling() {
        ...
        mapWithDecimals.put("lti13", "1.5"); // Decimal string for long field
    ...
    public void testInvalidStringHandling() {
        ...
        mapWithInvalidStrings.put("lti13", "abc123"); // Mixed string
        ...
        assertNull("Mixed string should return null", content.getLti13());
    }
    ...
    public void testNullAndEmptyHandling() {
        ...
        assertNull("Null lti13 should return null", content.getLti13());
    }
