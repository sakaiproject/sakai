...
public interface SakaiAccessTokenService {
    ...
    final String SAT_CACHE_NAME = "org.sakaiproject.lti.impl.SakaiAccessTokenServiceImpl_cache";

    final String PROPERTY_PUBLIC = "lti.advantage.lti13servlet.public";
    final String PROPERTY_PRIVATE = "lti.advantage.lti13servlet.private";

    final String PROPERTY_DIRECTAPI_ENABLED = LTIService.PROPERTY_DIRECTAPI_ENABLED;
    final String PROPERTY_WEBAPI_ENABLED = LTIService.PROPERTY_WEBAPI_ENABLED;
