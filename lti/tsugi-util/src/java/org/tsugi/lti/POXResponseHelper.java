...
/**
 * Static convenience methods for building POX (LTI 1.1 outcome) response XML.
 * Delegates to {@link POXResponseBuilder} for construction; use this class for
 * one-off success/failure/unsupported/etc. responses without using the builder directly.
 */
@Slf4j
public class POXResponseHelper {
