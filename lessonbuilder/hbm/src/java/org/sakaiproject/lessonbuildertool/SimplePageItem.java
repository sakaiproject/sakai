...
public class SimplePageItem {
	...
	public SimplePageItem() {

	}

	public SimplePageItem(long id, long pageId, int sequence, int type, String sakaiId, String name) {
		this.id = id;
		this.pageId = pageId;
	...
	public SimplePageItem(long pageId, int sequence, int type, String sakaiId, String name) {
		this.pageId = pageId;
		this.sequence = sequence;
		this.type = type;
		this.sakaiId = sakaiId;
