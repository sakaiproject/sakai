...
public class LessonsGradeInfoProvider implements ExternalAssignmentProvider, ExternalAssignmentProviderCompat {
    ...
    @Setter private GradebookExternalAssessmentService geaService;
    ...
    private SimplePageItem getAssignment(String id) {
        try {
            int itemId = Integer.parseInt(id.replace(LESSON_BUILDER_ID_PREPEND, ""));
            return simplePageToolDao.findItem(itemId);
