...
/**
 * This produces a page that closes the parent page. This only needs to be used when the popup for
 * an item picker (i.e. Add Quiz, Add Forum Topic) opens a new page to create a new Quiz, Topic, etc.
 * and must communicate to its parent page on whether or not to refresh.
 * 
 * @author Charlie Groll 
 * 
 */
public class ClosePageProducer implements ViewComponentProducer, ViewParamsReporter {
	...
	public void fillComponents(UIContainer tofill, ViewParameters viewparams, ComponentChecker checker) {
		...
		CloseViewParameters params = (CloseViewParameters) viewparams;
		UIOutput.make(tofill, "refresh", "refresh = " + params.getRefresh() + ";");
	}
