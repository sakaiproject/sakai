...
/**
 */
public class TestStandaloneSectionAwareness extends GradebookTestBase {
	private static final Log log = LogFactory.getLog(TestStandaloneSectionAwareness.class);
