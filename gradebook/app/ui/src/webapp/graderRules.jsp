	...
	<div class="portletBody">
	  <h:form id="gbForm">
			...
			<h:panelGroup rendered="#{graderRulesBean.assistantsDefined && (graderRulesBean.categoriesDefined || graderRulesBean.sectionsDefined)}">
				...
				<f:verbatim><div class="gbSection selectGrader"></f:verbatim>
				...
				<h:panelGroup rendered="#{graderRulesBean.selectedGrader != null}">
					...
					<t:dataTable
						...
						<h:column>
							<h:outputText value="#{graderRulesBean.selectedGrader.graderName}" rendered="#{rowIndex == 0}" 
								styleClass="graderName" />
						</h:column>
						<h:column>
					...
					<f:verbatim><div class="graderRulesAdd"></f:verbatim>
