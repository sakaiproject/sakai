 ...
 *
 */
public abstract class SpreadsheetDataDownloaderBase {
	protected abstract void writeDataToResponse(List<List<Object>> spreadsheetData, String fileName, HttpServletResponse response);
	 ...
	 */
	public void download(List<List<Object>> spreadsheetData, String fileName) {
        FacesContext faces = FacesContext.getCurrentInstance();
        HttpServletResponse response = (HttpServletResponse)faces.getExternalContext().getResponse();
        protectAgainstInstantDeletion(response);
       	writeDataToResponse(spreadsheetData, fileName, response);
