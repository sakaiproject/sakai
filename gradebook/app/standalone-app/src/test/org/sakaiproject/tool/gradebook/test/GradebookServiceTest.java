...
public class GradebookServiceTest extends GradebookTestBase {
    ...
    public void testCreateExternalAssessment() throws Exception {
        ...
        gradebookExternalAssessmentService.addExternalAssessment(GRADEBOOK_UID, EXT_ID_1, null, EXT_TITLE_1, 10, new Date(), "Samigo");
        ...
        try {
        	gradebookExternalAssessmentService.addExternalAssessment(GRADEBOOK_UID, "A unique external id", null, ASN_1, 10, new Date(), "Samigo");
            fail();
        } catch (ConflictingAssignmentNameException e) {}

        // Make sure that external name conflicts are detected
        try {
        	gradebookExternalAssessmentService.addExternalAssessment(GRADEBOOK_UID, "Another unique external id", null, EXT_TITLE_1, 10, new Date(), "Samigo");
            fail();
        } catch (ConflictingAssignmentNameException e) {}

        // Make sure that external id conflicts are detected
        try {
        	gradebookExternalAssessmentService.addExternalAssessment(GRADEBOOK_UID, EXT_ID_1, null, "A unique title", 10, new Date(), "Samigo");
            fail();
        ...
        gradebookExternalAssessmentService.addExternalAssessment(GRADEBOOK_UID, floatingExtId, null, "AFractionalAssessment", floatingPoints, new Date(), "Samigo");
    ...
    public void testModifyExternalAssessment() throws Exception {
        Assert.assertTrue(gradebookFrameworkService.isGradebookDefined(GRADEBOOK_UID));
        gradebookExternalAssessmentService.addExternalAssessment(GRADEBOOK_UID, EXT_ID_1, null, EXT_TITLE_1, 10, new Date(), "Samigo");
        gradebookExternalAssessmentService.updateExternalAssessment(GRADEBOOK_UID, EXT_ID_1, null, EXT_TITLE_1, 20, null);
    ...
    public void testCreateExternalGradeRecords() throws Exception {
        ...
        gradebookExternalAssessmentService.updateExternalAssessmentScore(gb.getUid(), EXT_ID_1, "student1", new Double(5));
    ...
    public void testModifyExternalGradeRecords() throws Exception {
        ...
        // Add the external assessment score
        Gradebook gb = gradebookManager.getGradebook(GRADEBOOK_UID);
        gradebookExternalAssessmentService.updateExternalAssessmentScore(gb.getUid(), EXT_ID_1, "student1", new Double(2));
    ...
    public void testUpdateMultipleScores() throws Exception {
        ...
        gradebookExternalAssessmentService.updateExternalAssessmentScores(gb.getUid(), EXT_ID_1, studentUidsToScores);
        cgr = gradebookManager.getStudentCourseGradeRecord(gb, "student1");
        ...
        gradebookExternalAssessmentService.updateExternalAssessmentScores(gb.getUid(), EXT_ID_1, new HashMap());
        cgr = gradebookManager.getStudentCourseGradeRecord(gb, "student2");
        Assert.assertTrue(cgr.getPointsEarned().equals(new Double(4)));
    }
    ...
    public void testRemoveExternalAssignment() throws Exception {
        ...
        // Add the external assessment score
        gradebookExternalAssessmentService.updateExternalAssessmentScore(GRADEBOOK_UID, EXT_ID_1, "student1", new Double(5));
        CourseGradeRecord cgr = gradebookManager.getStudentCourseGradeRecord(gb, "student1");
        ...
        gradebookExternalAssessmentService.addExternalAssessment(GRADEBOOK_UID, EXT_ID_1, null, "some other unique title", 10, new Date(), "Samigo");        
    }
	...
	public void testIsAssignmentDefined() throws Exception {
		...
		gradebookExternalAssessmentService.addExternalAssessment(GRADEBOOK_UID, "Is Assignment Defined ID", null, assignmentTitle, 10, new Date(), "Assignments");
    ...
    public void testExternalAssignmentWithZeroPoints() throws Exception {
        ...
        try{
        	gradebookExternalAssessmentService.addExternalAssessment(GRADEBOOK_UID, EXT_ID_1, null, EXT_TITLE_1, 0, new Date(), "Samigo");
            fail();
        }catch(AssignmentHasIllegalPointsException e){}

        gradebookExternalAssessmentService.addExternalAssessment(GRADEBOOK_UID, EXT_ID_1, null, EXT_TITLE_1, 10, new Date(), "Samigo");
        try{
        	gradebookExternalAssessmentService.updateExternalAssessment(GRADEBOOK_UID, EXT_ID_1, null, EXT_TITLE_1,0, null);
            fail();
        } catch(AssignmentHasIllegalPointsException e) {}
    }
    ...
    public void testDuplicateExternalIds() throws Exception {
        ...
        try {
        	gradebookExternalAssessmentService.addExternalAssessment(GRADEBOOK_UID, EXT_ID_1, null, "some unique title", 10, new Date(), "Samigo");
            fail();
        } catch (ConflictingExternalIdException e) {}
