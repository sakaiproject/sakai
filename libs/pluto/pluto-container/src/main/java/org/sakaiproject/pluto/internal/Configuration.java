...
public class Configuration {
    ...
    public static final ResourceBundle BUNDLE =
        PropertyResourceBundle.getBundle("org.sakaiproject.pluto.core.pluto-configuration");

    private static final String DESCRIPTOR_SERVICE =
        "org.sakaiproject.pluto.descriptors.services.PortletAppDescriptorService";


    /**
     * org.sakaiproject.pluto.ALLOW_BUFFER
     */
    private static final String BUFFER_SUPPORT =
        "org.sakaiproject.pluto.ALLOW_BUFFER";

    /**
     * org.sakaiproject.pluto.PREVENT_UNECESSARY_CROSS_CONTEXT
     */
