        ...
        extends HtmlRenderer
{
        ...
        throws IOException
    {
        ...
        writer.startElement(
                header ? org.apache.myfaces.shared_tomahawk.renderkit.html.HTML.THEAD_ELEM : HTML.TFOOT_ELEM, component);
        ...
        String styleClass = (component instanceof HtmlPanelGrid)
            ...
            : (header ?
                         ...
                         (String)component.getAttributes().get(
                                 org.apache.myfaces.shared_tomahawk.renderkit.JSFAttr.FOOTER_CLASS_ATTR));
        if (styleClass != null)
        {
        ...
        throws IOException
    {
        ...
        else
        {
            columnClasses = (String)component.getAttributes().get(
                    org.apache.myfaces.shared_tomahawk.renderkit.JSFAttr.COLUMN_CLASSES_ATTR);
