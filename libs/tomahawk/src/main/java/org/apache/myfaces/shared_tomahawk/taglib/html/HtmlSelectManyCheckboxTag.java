...
// Generated from class jakarta.faces.component.html._HtmlSelectManyCheckbox.
//
// WARNING: This file was automatically generated. Do not edit it directly,
//          or you will lose your changes.
...
{
    public HtmlSelectManyCheckboxTag()
    {    
    }
    ...
    private ValueExpression _unselectedClass;
    
    public void setUnselectedClass(ValueExpression unselectedClass)
    {
        _unselectedClass = unselectedClass;
    }
    ...
    {
        if (!(component instanceof jakarta.faces.component.html.HtmlSelectManyCheckbox))
        {
            throw new IllegalArgumentException("Component "+
                component.getClass().getName() +" is no jakarta.faces.component.html.HtmlSelectManyCheckbox");
        }
        
        jakarta.faces.component.html.HtmlSelectManyCheckbox comp = (jakarta.faces.component.html.HtmlSelectManyCheckbox) component;
        ...
        if (_unselectedClass != null)
        {
            comp.setValueExpression("unselectedClass", _unselectedClass);
        } 
        if (_label != null)
        {
