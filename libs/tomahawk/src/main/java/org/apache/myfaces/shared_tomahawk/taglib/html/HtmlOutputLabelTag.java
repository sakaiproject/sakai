    ...
    extends jakarta.faces.webapp.UIComponentELTag
{
    ...
    {
        if (!(component instanceof jakarta.faces.component.html.HtmlOutputLabel))
        {
            throw new IllegalArgumentException("Component "+
                component.getClass().getName() +" is no jakarta.faces.component.html.HtmlOutputLabel");
        }
        
        jakarta.faces.component.html.HtmlOutputLabel comp = (jakarta.faces.component.html.HtmlOutputLabel) component;
