 ...
 * @version $Revision: 1380845 $ $Date: 2012-09-04 15:10:04 -0500 (Tue, 04 Sep 2012) $
 */
    ...
    */
    ...
    private boolean hasSubmittingBehavior(Map<String, List<ClientBehavior>> clientBehaviors, String eventName)
    {
        ...
        if (eventBehaviors != null && !eventBehaviors.isEmpty())
        {
            ...
            // instance created in jakarta.faces.component.UIComponentBase.addClientBehavior(String, ClientBehavior), but
                                     ...
                                     UIComponent nestingForm)
    {
        ...
        String strParamValue = value != null ? org.apache.myfaces.shared_tomahawk.renderkit.html.util.HTMLEncoder.encode(
            ...
            throws IOException
    {
        ...
        {
            writer.writeText (org.apache.myfaces.shared_tomahawk.renderkit.RendererUtils.getStringValue
