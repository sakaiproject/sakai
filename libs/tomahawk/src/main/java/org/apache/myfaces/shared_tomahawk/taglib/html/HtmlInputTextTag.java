    ...
    extends jakarta.faces.webapp.UIComponentELTag
{
    ...
    {
        if (!(component instanceof jakarta.faces.component.html.HtmlInputText))
        {
            throw new IllegalArgumentException("Component "+
                component.getClass().getName() +" is no jakarta.faces.component.html.HtmlInputText");
        }
        
        jakarta.faces.component.html.HtmlInputText comp = (jakarta.faces.component.html.HtmlInputText) component;
