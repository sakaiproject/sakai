...
// Generated from class jakarta.faces.component._UISelectItems.
//
// WARNING: This file was automatically generated. Do not edit it directly,
//          or you will lose your changes.
    ...
    extends jakarta.faces.webapp.UIComponentELTag
{
    ...
    {
        if (!(component instanceof jakarta.faces.component.UISelectItems))
        {
            throw new IllegalArgumentException("Component "+
                component.getClass().getName() +" is no jakarta.faces.component.UISelectItems");
        }
        
        jakarta.faces.component.UISelectItems comp = (jakarta.faces.component.UISelectItems) component;
