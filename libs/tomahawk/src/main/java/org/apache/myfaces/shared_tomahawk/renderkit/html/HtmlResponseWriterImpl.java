        ...
        extends ResponseWriter
{
    ...
    public void writeAttribute(String name, Object value, String componentPropertyName) throws IOException
    {
        ...
        else
        {
            ...
            _currentWriter.write(name);
            _currentWriter.write("=\"");
            org.apache.myfaces.shared_tomahawk.renderkit.html.util.HTMLEncoder.encode(_currentWriter,
    ...
    public void writeURIAttribute(String name, Object value, String componentPropertyName) throws IOException
    {
        ...
        else
        {
            ...
            */
            ...
            org.apache.myfaces.shared_tomahawk.renderkit.html.util.HTMLEncoder.encodeURIAtributte(_currentWriter,
    ...
    public void writeText(char cbuf[], int off, int len) throws IOException
    {
        ...
        else if (isTextarea())
        {
            ...
            org.apache.myfaces.shared_tomahawk.renderkit.html.util.HTMLEncoder.encode(
