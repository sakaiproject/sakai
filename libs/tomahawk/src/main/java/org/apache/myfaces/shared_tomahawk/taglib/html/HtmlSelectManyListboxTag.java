    ...
    extends jakarta.faces.webapp.UIComponentELTag
{
    ...
    {
        if (!(component instanceof jakarta.faces.component.html.HtmlSelectManyListbox))
        {
            throw new IllegalArgumentException("Component "+
                component.getClass().getName() +" is no jakarta.faces.component.html.HtmlSelectManyListbox");
        }
        
        jakarta.faces.component.html.HtmlSelectManyListbox comp = (jakarta.faces.component.html.HtmlSelectManyListbox) component;
