...
public class HtmlMessage extends org.apache.myfaces.component.html.ext.AbstractHtmlMessage
{
    ...
    {
        return (String) getStateHelper().eval(PropertyKeys.summaryFormat);
    }
    
    public void setSummaryFormat(String summaryFormat)
    {
        getStateHelper().put(PropertyKeys.summaryFormat, summaryFormat ); 
    }    
    // Property: detailFormat
    public String getDetailFormat()
    {
        return (String) getStateHelper().eval(PropertyKeys.detailFormat);
    }
    
    public void setDetailFormat(String detailFormat)
    {
        getStateHelper().put(PropertyKeys.detailFormat, detailFormat ); 
    }    
    // Property: replaceIdWithLabel
    public boolean isReplaceIdWithLabel()
    {
        return (Boolean) getStateHelper().eval(PropertyKeys.replaceIdWithLabel, true);
    }
    
    public void setReplaceIdWithLabel(boolean replaceIdWithLabel)
    {
        getStateHelper().put(PropertyKeys.replaceIdWithLabel, replaceIdWithLabel ); 
    }    
    // Property: forceSpan
    public boolean isForceSpan()
    {
        return (Boolean) getStateHelper().eval(PropertyKeys.forceSpan, false);
    }
    
    public void setForceSpan(boolean forceSpan)
    {
        getStateHelper().put(PropertyKeys.forceSpan, forceSpan ); 
    }    
    // Property: style
