        ...
        extends HtmlRenderer
{
    ...
    public void encodeEnd(FacesContext facesContext, UIComponent uiComponent) throws IOException
    {
        ...
        Converter converter;
        List selectItemList = org.apache.myfaces.shared_tomahawk.renderkit.RendererUtils.getSelectItemList(
                selectOne, facesContext);
        converter = HtmlRendererUtils.findUIOutputConverterFailSafe(facesContext, selectOne);
        
        Object currentValue = 
            org.apache.myfaces.shared_tomahawk.renderkit.RendererUtils.getStringFromSubmittedValueOrLocalValueReturnNull(
