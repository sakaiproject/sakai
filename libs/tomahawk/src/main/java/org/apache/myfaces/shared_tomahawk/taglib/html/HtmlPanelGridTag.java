    ...
    extends jakarta.faces.webapp.UIComponentELTag
{
    ...
    {
        if (!(component instanceof jakarta.faces.component.html.HtmlPanelGrid))
        {
            throw new IllegalArgumentException("Component "+
                component.getClass().getName() +" is no jakarta.faces.component.html.HtmlPanelGrid");
        }
        
        jakarta.faces.component.html.HtmlPanelGrid comp = (jakarta.faces.component.html.HtmlPanelGrid) component;
