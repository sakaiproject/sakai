...
public class HtmlPopup extends org.apache.myfaces.custom.popup.AbstractHtmlPopup
{
    ...
    {
        return (Integer) getStateHelper().eval(PropertyKeys.displayAtDistanceX);
    }
    
    public void setDisplayAtDistanceX(Integer displayAtDistanceX)
    {
        getStateHelper().put(PropertyKeys.displayAtDistanceX, displayAtDistanceX ); 
    }    
    // Property: displayAtDistanceY
    public Integer getDisplayAtDistanceY()
    {
        return (Integer) getStateHelper().eval(PropertyKeys.displayAtDistanceY);
    }
    
    public void setDisplayAtDistanceY(Integer displayAtDistanceY)
    {
        getStateHelper().put(PropertyKeys.displayAtDistanceY, displayAtDistanceY ); 
    }    
    // Property: closePopupOnExitingElement
    public Boolean getClosePopupOnExitingElement()
    {
        return (Boolean) getStateHelper().eval(PropertyKeys.closePopupOnExitingElement);
    }
    
    public void setClosePopupOnExitingElement(Boolean closePopupOnExitingElement)
    {
        getStateHelper().put(PropertyKeys.closePopupOnExitingElement, closePopupOnExitingElement ); 
    }    
    // Property: closePopupOnExitingPopup
    public Boolean getClosePopupOnExitingPopup()
    {
        return (Boolean) getStateHelper().eval(PropertyKeys.closePopupOnExitingPopup);
    }
    
    public void setClosePopupOnExitingPopup(Boolean closePopupOnExitingPopup)
    {
        getStateHelper().put(PropertyKeys.closePopupOnExitingPopup, closePopupOnExitingPopup ); 
    }    
    // Property: layout
