    ...
    extends jakarta.faces.webapp.UIComponentELTag
{
    ...
    {
        if (!(component instanceof jakarta.faces.component.html.HtmlSelectBooleanCheckbox))
        {
            throw new IllegalArgumentException("Component "+
                component.getClass().getName() +" is no jakarta.faces.component.html.HtmlSelectBooleanCheckbox");
        }
        
        jakarta.faces.component.html.HtmlSelectBooleanCheckbox comp = (jakarta.faces.component.html.HtmlSelectBooleanCheckbox) component;
