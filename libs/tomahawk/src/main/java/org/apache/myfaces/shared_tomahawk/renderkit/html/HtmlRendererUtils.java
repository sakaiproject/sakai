...
public final class HtmlRendererUtils
{
        ...
        if (component instanceof ClientBehaviorHolder)
        {
            ...
            if (clientBehaviors != null && !clientBehaviors.isEmpty())
            {
                ...
                String behaviorEventName = paramMap
                        .get("jakarta.faces.behavior.event");
            ...
            List selectItemList) throws IOException
    {
        ...
        for (Iterator it = selectItemList.iterator(); it.hasNext();)
        {
            ...
            {
                String itemStrValue = org.apache.myfaces.shared_tomahawk.renderkit.RendererUtils
    ...
    public static void writePrettyLineSeparator(FacesContext facesContext)
            throws IOException
    {
        if (org.apache.myfaces.shared_tomahawk.config.MyfacesConfig.getCurrentInstance(
    ...
    public static boolean renderHTMLAttributeWithOptionalStartElement(
            ...
            throws IOException
    {
        if (!org.apache.myfaces.shared_tomahawk.renderkit.RendererUtils
            ...
            ResponseWriter writer, UIComponent component) throws IOException
    {
        ...
        else
        {
            captionClass = (String) component.getAttributes()
                    .get(org.apache.myfaces.shared_tomahawk.renderkit.JSFAttr.CAPTION_CLASS_ATTR);
            captionStyle = (String) component.getAttributes()
                    .get(org.apache.myfaces.shared_tomahawk.renderkit.JSFAttr.CAPTION_STYLE_ATTR);
        }
    ...
    public static String getDisplayValueOnlyStyleClass(UIComponent component)
    {
        ...
        {
            if (((org.apache.myfaces.shared_tomahawk.component.DisplayValueOnlyCapable) component)
            ...
            while ((parent = parent.getParent()) != null)
            {
                if (parent instanceof org.apache.myfaces.shared_tomahawk.component.DisplayValueOnlyCapable
                        && ((org.apache.myfaces.shared_tomahawk.component.DisplayValueOnlyCapable) parent)
                                .getDisplayValueOnlyStyleClass() != null)
                {
                    return ((org.apache.myfaces.shared_tomahawk.component.DisplayValueOnlyCapable) parent)
                            .getDisplayValueOnlyStyleClass();
                }
            }
        }
            ...
            boolean disabled) throws IOException
    {
        ...
        else
        {
            labelClass = (String) component.getAttributes()
                    .get(org.apache.myfaces.shared_tomahawk.renderkit.JSFAttr.ENABLED_CLASS_ATTR);
        }
        if (labelClass != null)
        {
            writer.writeAttribute("class", labelClass, "labelClass");
