    ...
    extends jakarta.faces.webapp.UIComponentELTag
{
    ...
    {
        if (!(component instanceof jakarta.faces.component.html.HtmlOutputFormat))
        {
            throw new IllegalArgumentException("Component "+
                component.getClass().getName() +" is no jakarta.faces.component.html.HtmlOutputFormat");
        }
        
        jakarta.faces.component.html.HtmlOutputFormat comp = (jakarta.faces.component.html.HtmlOutputFormat) component;
