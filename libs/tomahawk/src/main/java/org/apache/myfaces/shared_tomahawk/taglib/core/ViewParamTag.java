...
// Generated from class jakarta.faces.component.UIViewParameter.
//
// WARNING: This file was automatically generated. Do not edit it directly,
//          or you will lose your changes.
    ...
    extends jakarta.faces.webapp.UIComponentELTag
{
    ...
    {
        if (!(component instanceof jakarta.faces.component.UIViewParameter))
        {
            throw new IllegalArgumentException("Component "+
                component.getClass().getName() +" is no jakarta.faces.component.UIViewParameter");
        }
        
        jakarta.faces.component.UIViewParameter comp = (jakarta.faces.component.UIViewParameter) component;
