    ...
    extends jakarta.faces.webapp.UIComponentELTag
{
    ...
    {
        if (!(component instanceof jakarta.faces.component.html.HtmlInputTextarea))
        {
            throw new IllegalArgumentException("Component "+
                component.getClass().getName() +" is no jakarta.faces.component.html.HtmlInputTextarea");
        }
        
        jakarta.faces.component.html.HtmlInputTextarea comp = (jakarta.faces.component.html.HtmlInputTextarea) component;
