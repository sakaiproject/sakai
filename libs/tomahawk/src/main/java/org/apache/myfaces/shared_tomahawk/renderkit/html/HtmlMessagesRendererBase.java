        ...
        extends HtmlMessageRendererBase
{
    ...
    protected boolean isTooltip(UIComponent component)
    {
        ...
        else
        {
            return org.apache.myfaces.shared_tomahawk.renderkit.RendererUtils.getBooleanAttribute(component, 
                    org.apache.myfaces.shared_tomahawk.renderkit.JSFAttr.TOOLTIP_ATTR, false);
        }
    }
    ...
    protected boolean isRedisplay(UIComponent component)
    {
        ...
        return org.apache.myfaces.shared_tomahawk.renderkit.RendererUtils.getBooleanAttribute(
                component, org.apache.myfaces.shared_tomahawk.renderkit.JSFAttr.REDISPLAY_ATTR, true);
    ...
    private static class MessagesIterator implements Iterator
    {
                ...
                UIComponent forComponent)
        {
            ...
            if(forComponent != null)
            {
                ...
                _clientIdsWithMessagesIterator = org.apache.myfaces.shared_tomahawk.util.NullIterator.instance();
            }
            else 
            {
                if (globalOnly)
