    ...
    extends jakarta.faces.webapp.UIComponentELTag
{
    ...
    {
        if (!(component instanceof jakarta.faces.component.html.HtmlOutputLink))
        {
            throw new IllegalArgumentException("Component "+
                component.getClass().getName() +" is no jakarta.faces.component.html.HtmlOutputLink");
        }
        
        jakarta.faces.component.html.HtmlOutputLink comp = (jakarta.faces.component.html.HtmlOutputLink) component;
