    ...
    extends jakarta.faces.webapp.UIComponentELTag
{
    ...
    {
        if (!(component instanceof jakarta.faces.component.html.HtmlForm))
        {
            throw new IllegalArgumentException("Component "+
                component.getClass().getName() +" is no jakarta.faces.component.html.HtmlForm");
        }
        
        jakarta.faces.component.html.HtmlForm comp = (jakarta.faces.component.html.HtmlForm) component;
