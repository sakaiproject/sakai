...
public class XmlTransform extends org.apache.myfaces.custom.transform.AbstractXmlTransform
{
    ...
    {
        getStateHelper().put(PropertyKeys.contentLocation, contentLocation ); 
    }    
    // Property: stylesheet
    ...
    {
        getStateHelper().put(PropertyKeys.stylesheet, stylesheet ); 
    }    
    ...
    {
        getStateHelper().put(PropertyKeys.stylesheetLocation, stylesheetLocation ); 
    }    
