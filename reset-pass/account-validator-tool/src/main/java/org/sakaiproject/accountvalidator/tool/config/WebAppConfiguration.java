 ...
 */
package org.sakaiproject.accountvalidator.tool.config;
...
public class WebAppConfiguration implements WebApplicationInitializer {
    ...
    public void onStartup(ServletContext servletContext) throws ServletException {
        ...
        Dynamic servlet = servletContext.addServlet("sakai.accountvalidator", new DispatcherServlet(rootContext));
        servlet.addMapping("/");
