...
( id bigint not null auto_increment, entity_ref varchar(265) character set ascii not null, 
...
calendar_time datetime not null, calendar_time_label_key varchar(40) character set ascii, title varchar(255) not null, 
entity_ref varchar(265) character set ascii not null, entity_type bigint not null, subtype varchar(255), context_id bigint not null, 
...
news_time_label_key varchar(40) character set ascii, title varchar(255) not null, 
entity_ref varchar(265) character set ascii not null, entity_type bigint not null, subtype varchar(255), 
...
calendar_time_label_key varchar(40) character set ascii, title varchar(255) not null, 
entity_ref varchar(265) character set ascii not null, subtype varchar(255), entity_type bigint not null, context_id bigint not null, 
primary key (id) ); 
