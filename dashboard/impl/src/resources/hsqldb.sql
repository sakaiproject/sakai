...
entity_ref varchar(265) not null, entity_type bigint not null, subtype varchar(255), context_id bigint not null, 
...
news_time_label_key varchar(40), title varchar(255) not null, entity_ref varchar(265) not null, entity_type bigint not null, subtype varchar(255), 
