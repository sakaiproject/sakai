...
//	protected TreeModel copyTreeModel(TreeModel treeModel){
//		TreeModel newTreeModel = null;
//		if(treeModel != null && treeModel.getRoot() != null){
//
//			DefaultMutableTreeNode rootNode = copyNode(null, (DefaultMutableTreeNode)treeModel.getRoot());
//			newTreeModel = new DefaultTreeModel(rootNode);
//		}
//		return newTreeModel;
//	}
//	
...
//	 * @return
//	 */
//	protected DefaultMutableTreeNode copyNode(DefaultMutableTreeNode parent, DefaultMutableTreeNode origParent)
//	{
//		if(parent == null){
//			parent = new DefaultMutableTreeNode((NodeModel) origParent.getUserObject()){
//				@Override
...
//			};
//		}
//		for (int i = 0; i < origParent.getChildCount(); i++)
//		{
//			NodeModel nodeModel = (NodeModel) ((DefaultMutableTreeNode) origParent.getChildAt(i)).getUserObject();
//			DefaultMutableTreeNode child = new DefaultMutableTreeNode(nodeModel){
//				@Override
//				public boolean isLeaf() {
//					return ((NodeModel) this.getUserObject()).getNode().childNodeIds.isEmpty();
//				}
...
//			parent.add(child);
//			
//			copyNode(child, (DefaultMutableTreeNode) origParent.getChildAt(i));
//		}
//		return parent;
//	}
