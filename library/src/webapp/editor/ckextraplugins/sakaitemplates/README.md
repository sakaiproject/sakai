## Default CKEditor Templates Updated in SAK-41954
The templates included in the CKEditor were updated and improved in [SAK-41954](https://jira.sakaiproject.org/browse/SAK-41954).

If you are looking for the old templates you can find the out-of-the-box version on the [CKEditor website](https://ckeditor.com/cke4/addon/templates) or the previous Sakai version below.

###Previous version included with Sakai
Replace template contents in default.js with the following to add back the outdated templates.
```javascript
    {
        title: 'Two-column',
        image: 'template4.gif',
