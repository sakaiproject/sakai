...
alter table SAM_ATTACHMENT_T MODIFY RESOURCEID TEXT,  MODIFY CREATEDBY varchar(255) not null, MODIFY LASTMODIFIEDBY varchar(255) not null;
...
alter table SAM_PUBLISHEDATTACHMENT_T  MODIFY RESOURCEID TEXT, MODIFY CREATEDBY varchar(255) not null, MODIFY LASTMODIFIEDBY varchar(255) not null;
