...
-- SAK-19951 create statement for scheduler_trigger_events
create table scheduler_trigger_events (uuid varchar(36) not null, eventType varchar(255) not null, jobName varchar(255) not null, triggerName varchar(255), eventTime timestamp not null, message clob(255), primary key (uuid));
