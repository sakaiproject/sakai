...
create index CONTENT_RESOURCE_DELETE_CI on CONTENT_RESOURCE (CONTEXT);
...
create index CONTENT_RESOURCE_DELETE_RTI on CONTENT_RESOURCE (RESOURCE_TYPE_ID);
...
alter table ASSIGNMENT_SUBMISSION add SUBMITTER_ID VARCHAR(99) default null;
