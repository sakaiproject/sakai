...
Set CALENDAR_START_DATE = 0
Where CALENDAR_START_DATE is null;

Update SAM_ASSESSACCESSCONTROL_T
Set CALENDAR_DUE_DATE = 0
Where CALENDAR_DUE_DATE is null;

Update SAM_ASSESSACCESSCONTROL_T
Set CALENDAR_RETRACT_DATE = 0
Where CALENDAR_RETRACT_DATE is null;

Update SAM_PUBLISHEDACCESSCONTROL_T
Set CALENDAR_START_DATE = 0
Where CALENDAR_START_DATE is null;
