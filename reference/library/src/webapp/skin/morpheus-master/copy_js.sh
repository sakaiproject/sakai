...
#     morpheus-master/morpheus.plugins.js morpheus-master/morpheus.scripts.js	
#     morpheus-master/morpheus.plugins.min.js morpheus-master/morpheus.scripts.min.js
# (3) Run this script from morpheus-master to send the combined and
#     minned js files into all the other skin sets
#
...
for folder in morpheus-examp-u morpheus-default morpheus-rtl; do
    for fn in js/morpheus.plugins.js js/morpheus.scripts.js js/morpheus.plugins.min.js js/morpheus.scripts.min.js; do
