		...
		function resizeFrame(updown){
			...
			<h:form id="syllabusEdit">
				...
				<h:panelGrid columns="1" styleClass="jsfFormTable" style="table-layout:fixed; width:100%">
					...
					<h:panelGroup>
						<h:selectOneRadio id="radioByItems" value="#{SyllabusTool.bulkEntry.addByItems}" styleClass="radioByItems radioOption" style="width:100%">
					...
					<h:panelGroup>
						<h:selectOneRadio id="radioByDate" value="#{SyllabusTool.bulkEntry.addByDate}" styleClass="radioByDate radioOption " style="width:100%">
