...
<sakai:stylesheet path="/syllabus/css/ui-lightness/jqueryui-editable.css" />
...
<script language="JavaScript">
	...
	$(function() {
		...
		}, '<%= org.sakaiproject.util.Web.escapeJavascript(thisId)%>');
	});
</script>
<style>
	.editItem:hover {
			...
			<syllabus:syllabus_if test="#{SyllabusTool.syllabusItem.redirectURL}">
					...
					<t:dataList value="#{SyllabusTool.entries}" var="eachEntry" layout="simple">
						<f:verbatim><h3><a href="#"></f:verbatim>		  
							...
							<f:subview id="dateInstructor" rendered="#{SyllabusTool.editAble}">
								<f:verbatim><br/><span style="font-weight: normal"></f:verbatim>
									<h:outputText value="("/>
									<h:outputText styleClass="editItem startTimeInput" value="#{eachEntry.entry.startDate}">
										<f:convertDateTime type="date" pattern="MM/dd/yyyy hh:mm a"/>
									</h:outputText>
									<h:outputText value=" - "/>
						...
						<f:verbatim>
							...
							<a href="#" class="editButton" style="display: none; float: right;"><img src="/library/image/silk/pencil.png" class="actionImage"></a>
							</h3>
						</f:verbatim>
						<f:verbatim><div></f:verbatim>
							...
							<!--syllabus:syllabus_htmlShowArea  styleClass="bodyInput" value="#{eachEntry.entry.asset}" /-->
							<f:verbatim></div></f:verbatim>
