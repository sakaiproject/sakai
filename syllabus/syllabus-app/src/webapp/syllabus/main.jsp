...
3) Summary for  tables in SyllabusTableComponent.java needs to be dynamic  and come from mess bundle - see message in SyllabusTableComponent.java  for details. --%>
	<h:form>
		 	<sakai:tool_bar>
			...
			<syllabus:syllabus_if test="#{SyllabusTool.syllabusItem.redirectURL}">
				<h:dataTable value="#{SyllabusTool.entries}" var="eachEntry" rendered="#{! SyllabusTool.syllabusItem.redirectURL}" style="margin-top:1em;clear:both;" summary="#{msgs.mainCaption}" >
					<h:column>
							...
							<h:dataTable value="#{eachEntry.attachmentList}" var="eachAttach" styleClass="indnt1" summary="">
							  <h:column>
									<f:facet name="header">
										<h:outputText value="" />
									</f:facet>
