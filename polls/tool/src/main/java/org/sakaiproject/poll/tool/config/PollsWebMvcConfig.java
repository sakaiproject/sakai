...
/**
 * Spring MVC + Thymeleaf configuration for the Polls tool.
 */
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "org.sakaiproject.poll.tool")
public class PollsWebMvcConfig implements WebMvcConfigurer, ApplicationContextAware {
