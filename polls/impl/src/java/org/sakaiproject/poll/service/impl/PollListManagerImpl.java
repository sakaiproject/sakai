...
public class PollListManagerImpl implements PollListManager,EntityTransferrer {
    ...
    public String mergeWithCreatorId(String siteId, Element root, String archivePath, String fromSiteId, Map<String, String> attachmentNames, Map<String, String> userIdTrans, Set<String> userListAllowImport, String creatorId) {
