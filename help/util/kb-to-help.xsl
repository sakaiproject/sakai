...
<xsl:text>
	...
	<xsl:template
		match="h3|h4|h5|h6|ol|li|i|u|b|ul|br|strong|em|col|hr|sup|p|cite|code|pre|dd|dt|dl|tt|sub|big|small">
		<xsl:copy>
			<xsl:apply-templates select="*|text()" />
		</xsl:copy>
	</xsl:template>
