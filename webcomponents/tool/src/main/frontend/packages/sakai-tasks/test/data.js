...
export const tasksUrl = /api\/users\/me\/tasks/;
export const tasksPostUrl = /api\/tasks/;
...
export const siteTasksUrl= `/api/sites/${siteId}/tasks`;

export const siteTasks = {
  canAddTask: true,
  tasks: [
    { priority: 5, due: 1674068901978, description: "Submit Ears", notes: "You need to submit the ears assignment", url: "/assn/ears", siteTitle: "XYZ" },
    { priority: 3, due: 1674068901978, description: "Do the shopping", siteTitle: "XYZ" },
  ],
};
