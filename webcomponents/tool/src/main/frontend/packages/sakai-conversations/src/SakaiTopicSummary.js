      ...
      <div class="topic-summary ${this.topic.numberOfUnreadPosts > 0 ? " unread" : ""}">
        <div class="type-icon">
          ${this.topic.type === QUESTION ? html`
            <sakai-icon type="questioncircle"
                class="question-icon"
                size="medium"
                aria-description="${this._i18n.question_tooltip}"
          ...
          <div class="discussion-icon-wrapper">
            <sakai-icon type="forums"
                ...
                size="small"
                aria-description="${this._i18n.discussion_tooltip}"
        ...
        <div class="topic-summary-pinned-indicator">
          ...
          <div>
            <sakai-icon type="pin"
                size="small"
                aria-description="${this._i18n.pinned_tooltip}"
          ...
          <div>
            <i class="si si-bookmark-fill"
                aria-description="${this._i18n.bookmarked_tooltip}"
          ...
          <div class="topic-status"
              ...
              aria-description="${this._i18n.topic_locked_tooltip}">
            <sakai-icon type="lock" size="small"></sakai-icon>
          </div>
          ` : nothing }
          ...
          <div class="topic-status"
              ...
              aria-description="${this._i18n.topic_hidden_tooltip}">
            <sakai-icon type="hidden" size="small"></sakai-icon>
          </div>
          ` : nothing }
          ${this._renderMenu()}
        </div>
        ...
        ${this.topic.numberOfUnreadPosts > 0 ? html`
          <sakai-icon type="circle"
              size="small"
              aria-description="${this._i18n.unread_tooltip}"
