...
export const course1 = { id: "sports_101", title: "Sports Science 101", course: true };
export const course2 = { id: "perm_found", title: "Permaculture Foundations", course: true };
export const course3 = { id: "eggs", title: "Eggs", course: true };
