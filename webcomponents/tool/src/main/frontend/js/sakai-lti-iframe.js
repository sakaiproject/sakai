...
class SakaiLTIIframe extends SakaiElement {
  ...
  render() {
    ...
    return html`
      <div class="sakai-iframe-launch-button" style="display:none;">
        <a href="${this.launchUrl}" class="btn btn-primary" role="button" target="_blank">${this.newWindowText}</a>
      </div>
      <div class="sakai-iframe-launch">
        <iframe src="${this.launchUrl}"
          ...
          <div class="sakai-iframe-launch-button">
            <a href="${this.launchUrl}" class="btn btn-primary" role="button" target="_blank">${this.newWindowText}</a>
          </div>
        </iframe>
      </div>
