...
import { Button } from "./assets/bootstrap/dist/js/bootstrap.esm.min.js";
export class SakaiButton extends LitElement {
  ...
  render() {
    return html`
      <link rel="stylesheet" href="/webcomponents/assets/bootstrap/dist/css/bootstrap.min.css">
      <button
        class="btn ${this.sakClass ? this.sakClass : "btn-secondary"}"
