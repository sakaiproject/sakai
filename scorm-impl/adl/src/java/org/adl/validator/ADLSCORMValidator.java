     ...
     mLogger.exiting( "ADLSCORMValidator", "performValidatorParse()" );  
      ...
      public boolean isRootElementValid()
      {
         ...
         if( rootNodeName.equals("manifest") )  
         {
            ...
            {
               String msgText = Messages.getString("ADLSCORMValidator.24", 
                  rootNodeName, rootNodeNamespace, 
                  DOMTreeUtility.IMSCP_NAMESPACE );  
               ...
               DetailedLogMessageCollection.getInstance().addMessage( new 
                  LogMessage ( MessageType.TERMINATE, msgText ) );           
            }
         }
         else if( rootNodeName.equals("lom") )  
         {
            ...
            {
               String msgText = Messages.getString("ADLSCORMValidator.30",
                  rootNodeName, rootNodeNamespace, 
                  DOMTreeUtility.IEEE_LOM_NAMESPACE );  
               ...
               DetailedLogMessageCollection.getInstance().addMessage( 
                  new LogMessage (MessageType.TERMINATE, msgText));
            }
         }
         return result;
      }
