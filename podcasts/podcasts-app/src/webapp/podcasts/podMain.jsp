...
<h:form id="podMainForm">
	...
	<h:dataTable value="#{podHomeBean.contents}" var="eachPodcast" rendered="#{podHomeBean.actPodcastsExist}" styleClass="table table-hover table-striped table-bordered" headerClass="d-none d-sm-table-cell" columnClasses="d-none d-sm-table-cell, d-none d-sm-table-cell, d-none d-sm-table-cell, d-none d-sm-table-cell, d-none d-sm-table-cell, d-none d-sm-table-cell, d-none d-sm-table-cell">
		<h:column>
