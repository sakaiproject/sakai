...
public class FeedbackTool extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (siteExists) {
            ...
            String serviceContactName = rb.getFormattedMessage("technical_team_name", (Object) new String[]{serviceName});
    ...
    private void formatProperties(ResourceLoader rb, Map<String, String> bundleMap, String serviceName) {
        ...
        for (String property : DYNAMIC_PROPERTIES) {
            if(property.equals("ask_instruction")) {
                ...
                bundleMap.put(property, MessageFormat.format(rb.getString(property), (Object) new String[]{name}));
                continue;
            }
            bundleMap.put(property, MessageFormat.format(rb.getString(property), (Object) new String[]{serviceName}));
        }

        if (serviceName!=null && !serviceName.isEmpty()){
            bundleMap.put("technical_link", MessageFormat.format(rb.getString("technical_link"), (Object) new String[]{serviceName}));
        }
        else {
