...
drop table SAM_STUDENTGRADINGSUMMARY_T if exists;
drop table SAM_TYPE_T if exists;
create table SAM_ANSWERFEEDBACK_T (ANSWERFEEDBACKID bigint generated by default as identity (start with 1), ANSWERID bigint not null, TYPEID varchar(255), TEXT varchar(4000), primary key (ANSWERFEEDBACKID));
create table SAM_ANSWER_T (ANSWERID bigint generated by default as identity (start with 1), ITEMTEXTID bigint not null, ITEMID bigint not null, TEXT varchar(4000), SEQUENCE bigint not null, LABEL varchar(20), ISCORRECT bit, GRADE varchar(80), SCORE float, primary key (ANSWERID));
...
create table SAM_ASSESSMENTBASE_T (ID bigint generated by default as identity (start with 1), isTemplate varchar(255) not null, PARENTID bigint, TITLE varchar(255), DESCRIPTION varchar(4000), COMMENTS varchar(4000), TYPEID bigint, INSTRUCTORNOTIFICATION integer, TESTEENOTIFICATION integer, MULTIPARTALLOWED integer, STATUS integer not null, CREATEDBY varchar(255) not null, CREATEDDATE timestamp not null, LASTMODIFIEDBY varchar(255) not null, LASTMODIFIEDDATE timestamp not null, ASSESSMENTTEMPLATEID bigint, primary key (ID));
create table SAM_ASSESSMENTGRADING_T (ASSESSMENTGRADINGID bigint generated by default as identity (start with 1), PUBLISHEDASSESSMENTID bigint not null, AGENTID varchar(255) not null, SUBMITTEDDATE timestamp, ISLATE bit not null, FORGRADE bit not null, TOTALAUTOSCORE float, TOTALOVERRIDESCORE float, FINALSCORE float, COMMENTS varchar(4000), GRADEDBY varchar(255), GRADEDDATE timestamp, STATUS integer not null, ATTEMPTDATE timestamp, TIMEELAPSED integer, primary key (ASSESSMENTGRADINGID));
...
create table SAM_ATTACHMENT_T (ATTACHMENTID bigint generated by default as identity (start with 1), ATTACHMENTTYPE varchar(255) not null, RESOURCEID varchar(255), FILENAME varchar(255), MIMETYPE varchar(80), FILESIZE bigint, DESCRIPTION varchar(4000), LOCATION varchar(4000), ISLINK bit, STATUS integer not null, CREATEDBY varchar(255) not null, CREATEDDATE timestamp not null, LASTMODIFIEDBY varchar(255) not null, LASTMODIFIEDDATE timestamp not null, ASSESSMENTID bigint, SECTIONID bigint, ITEMID bigint, primary key (ATTACHMENTID));
create table SAM_AUTHZDATA_T (ID bigint generated by default as identity (start with 1), lockId integer not null, AGENTID varchar(255) not null, FUNCTIONID varchar(255) not null, QUALIFIERID varchar(255) not null, EFFECTIVEDATE date, EXPIRATIONDATE date, LASTMODIFIEDBY varchar(255) not null, LASTMODIFIEDDATE date not null, ISEXPLICIT bit, primary key (ID), unique (AGENTID, FUNCTIONID, QUALIFIERID));
...
create table SAM_GRADINGSUMMARY_T (ASSESSMENTGRADINGSUMMARYID bigint generated by default as identity (start with 1), PUBLISHEDASSESSMENTID bigint not null, AGENTID varchar(255) not null, TOTALSUBMITTED integer, TOTALSUBMITTEDFORGRADE integer, LASTSUBMITTEDDATE timestamp, LASTSUBMITTEDASSESSMENTISLATE bit not null, SUMOF_AUTOSCOREFORGRADE float, AVERAGE_AUTOSCOREFORGRADE float, HIGHEST_AUTOSCOREFORGRADE float, LOWEST_AUTOSCOREFORGRADE float, LAST_AUTOSCOREFORGRADE float, SUMOF_OVERRIDESCOREFORGRADE float, AVERAGE_OVERRIDESCOREFORGRADE float, HIGHEST_OVERRIDESCOREFORGRADE float, LOWEST_OVERRIDESCOREFORGRADE float, LAST_OVERRIDESCOREFORGRADE float, SCORINGTYPE integer, ACCEPTEDASSESSMENTISLATE bit, FINALASSESSMENTSCORE float, FEEDTOGRADEBOOK bit, primary key (ASSESSMENTGRADINGSUMMARYID));
create table SAM_ITEMFEEDBACK_T (ITEMFEEDBACKID bigint generated by default as identity (start with 1), ITEMID bigint not null, TYPEID varchar(255) not null, TEXT varchar(4000), primary key (ITEMFEEDBACKID));
create table SAM_ITEMGRADING_T (ITEMGRADINGID bigint generated by default as identity (start with 1), ASSESSMENTGRADINGID bigint not null, PUBLISHEDITEMID bigint not null, PUBLISHEDITEMTEXTID bigint not null, AGENTID varchar(255) not null, SUBMITTEDDATE timestamp, PUBLISHEDANSWERID bigint, RATIONALE varchar(4000), ANSWERTEXT varchar(4000), AUTOSCORE float, OVERRIDESCORE float, COMMENTS varchar(4000), GRADEDBY varchar(255), GRADEDDATE timestamp, REVIEW bit, ATTEMPTSREMAINING integer, LASTDURATION varchar(36), primary key (ITEMGRADINGID));
...
create table SAM_ITEMTEXT_T (ITEMTEXTID bigint generated by default as identity (start with 1), ITEMID bigint not null, SEQUENCE bigint not null, TEXT varchar(4000), primary key (ITEMTEXTID));
create table SAM_ITEM_T (ITEMID bigint generated by default as identity (start with 1), SECTIONID bigint, ITEMIDSTRING varchar(255), SEQUENCE integer, DURATION integer, TRIESALLOWED integer, INSTRUCTION varchar(4000), DESCRIPTION varchar(4000), TYPEID bigint not null, GRADE varchar(80), SCORE float, HINT varchar(4000), HASRATIONALE bit, STATUS integer not null, CREATEDBY varchar(255) not null, CREATEDDATE timestamp not null, LASTMODIFIEDBY varchar(255) not null, LASTMODIFIEDDATE timestamp not null, primary key (ITEMID));
create table SAM_MEDIA_T (MEDIAID bigint generated by default as identity (start with 1), ITEMGRADINGID bigint, MEDIA varbinary(1000000000), FILESIZE bigint, MIMETYPE varchar(80), DESCRIPTION varchar(4000), LOCATION varchar(255), FILENAME varchar(255), ISLINK bit, ISHTMLINLINE bit, STATUS integer, CREATEDBY varchar(255), CREATEDDATE timestamp, LASTMODIFIEDBY varchar(255), LASTMODIFIEDDATE timestamp, DURATION varchar(36), primary key (MEDIAID));
...
create table SAM_PUBLISHEDANSWERFEEDBACK_T (ANSWERFEEDBACKID bigint generated by default as identity (start with 1), ANSWERID bigint not null, TYPEID varchar(255), TEXT varchar(4000), primary key (ANSWERFEEDBACKID));
create table SAM_PUBLISHEDANSWER_T (ANSWERID bigint generated by default as identity (start with 1), ITEMTEXTID bigint not null, ITEMID bigint not null, TEXT varchar(4000), SEQUENCE bigint not null, LABEL varchar(20), ISCORRECT bit, GRADE varchar(80), SCORE float, primary key (ANSWERID));
create table SAM_PUBLISHEDASSESSMENT_T (ID bigint generated by default as identity (start with 1), TITLE varchar(255), ASSESSMENTID bigint, DESCRIPTION varchar(4000), COMMENTS varchar(255), TYPEID bigint, INSTRUCTORNOTIFICATION integer, TESTEENOTIFICATION integer, MULTIPARTALLOWED integer, STATUS integer not null, CREATEDBY varchar(255) not null, CREATEDDATE timestamp not null, LASTMODIFIEDBY varchar(255) not null, LASTMODIFIEDDATE timestamp not null, primary key (ID));
...
create table SAM_PUBLISHEDITEMFEEDBACK_T (ITEMFEEDBACKID bigint generated by default as identity (start with 1), ITEMID bigint not null, TYPEID varchar(255) not null, TEXT varchar(4000), primary key (ITEMFEEDBACKID));
...
create table SAM_PUBLISHEDITEMTEXT_T (ITEMTEXTID bigint generated by default as identity (start with 1), ITEMID bigint not null, SEQUENCE bigint not null, TEXT varchar(4000), primary key (ITEMTEXTID));
create table SAM_PUBLISHEDITEM_T (ITEMID bigint generated by default as identity (start with 1), SECTIONID bigint not null, ITEMIDSTRING varchar(255), SEQUENCE integer, DURATION integer, TRIESALLOWED integer, INSTRUCTION varchar(4000), DESCRIPTION varchar(4000), TYPEID bigint not null, GRADE varchar(80), SCORE float, HINT varchar(4000), HASRATIONALE bit, STATUS integer not null, CREATEDBY varchar(255) not null, CREATEDDATE timestamp not null, LASTMODIFIEDBY varchar(255) not null, LASTMODIFIEDDATE timestamp not null, primary key (ITEMID));
...
create table SAM_PUBLISHEDSECTION_T (SECTIONID bigint generated by default as identity (start with 1), ASSESSMENTID bigint not null, DURATION integer, SEQUENCE integer, TITLE varchar(255), DESCRIPTION varchar(4000), TYPEID bigint not null, STATUS integer not null, CREATEDBY varchar(255) not null, CREATEDDATE timestamp not null, LASTMODIFIEDBY varchar(255) not null, LASTMODIFIEDDATE timestamp not null, primary key (SECTIONID));
...
create table SAM_QUESTIONPOOL_T (QUESTIONPOOLID bigint generated by default as identity (start with 1), TITLE varchar(255), DESCRIPTION varchar(255), PARENTPOOLID bigint, OWNERID varchar(255), ORGANIZATIONNAME varchar(255), DATECREATED timestamp, LASTMODIFIEDDATE timestamp, LASTMODIFIEDBY varchar(255), DEFAULTACCESSTYPEID bigint, OBJECTIVE varchar(255), KEYWORDS varchar(255), RUBRIC varchar(4000), TYPEID bigint, INTELLECTUALPROPERTYID bigint, primary key (QUESTIONPOOLID));
...
create table SAM_SECTION_T (SECTIONID bigint generated by default as identity (start with 1), ASSESSMENTID bigint not null, DURATION integer, SEQUENCE integer, TITLE varchar(255), DESCRIPTION varchar(4000), TYPEID bigint, STATUS integer not null, CREATEDBY varchar(255) not null, CREATEDDATE timestamp not null, LASTMODIFIEDBY varchar(255) not null, LASTMODIFIEDDATE timestamp not null, primary key (SECTIONID));
...
create table SAM_STUDENTGRADINGSUMMARY_T (STUDENTGRADINGSUMMARYID bigint generated by default as identity (start with 1), PUBLISHEDASSESSMENTID bigint not null, AGENTID varchar(255) not null, NUMBERRETAKE integer, CREATEDBY varchar(255) not null, CREATEDDATE timestamp not null, LASTMODIFIEDBY varchar(255) not null, LASTMODIFIEDDATE timestamp not null, primary key (STUDENTGRADINGSUMMARYID));
create table SAM_TYPE_T (TYPEID bigint generated by default as identity (start with 1), AUTHORITY varchar(255), DOMAIN varchar(255), KEYWORD varchar(255), DESCRIPTION varchar(4000), STATUS integer not null, CREATEDBY varchar(255) not null, CREATEDDATE timestamp not null, LASTMODIFIEDBY varchar(255) not null, LASTMODIFIEDDATE timestamp not null, primary key (TYPEID));
