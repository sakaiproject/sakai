...
*/
  ...
  public void setCalculatedQuestionFormula(String formula) {
	  this.match = formula + "|" + this.getCalculatedQuestionFormulaTolerance() + "," + this.getCalculatedQuestionFormulaDecimalPlaces();
  }
  
  public String getCalculatedQuestionFormula() {
	  return match.substring(0, match.indexOf('|'));
  }
  
  public void setCalculatedQuestionFormulaTolerance(String tolerance) {
	  match = this.getCalculatedQuestionFormula() + "|" + tolerance + "," + this.getCalculatedQuestionFormulaDecimalPlaces();
  }
  
  public String getCalculatedQuestionFormulaTolerance() {
	  return match.substring(match.indexOf('|')+1, match.indexOf(','));
  }
  
  public void setCalculatedQuestionFormulaDecimalPlaces(String decimalPlaces) {
	  this.match = this.getCalculatedQuestionFormula() + "|" + this.getCalculatedQuestionFormulaTolerance() + "," + decimalPlaces;
  }
  
  public String getCalculatedQuestionFormulaDecimalPlaces() {
  ...
  public void setCalculatedQuestionVariableMin(String min) {
	  this.match = min + "|" + this.getCalculatedQuestionVariableMax() + "," + this.getCalculatedQuestionVariableDecimalPlaces();
  }
 ...
 public void setCalculatedQuestionVariableMax(String max) {
	  this.match = this.getCalculatedQuestionVariableMin() + "|" + max + "," + this.getCalculatedQuestionVariableDecimalPlaces();
	 // TODO - update match with this value
 }
  /*
  * This is for display purposes. ONLY for calculated questions.
  */
 ...
 public void setCalculatedQuestionVariableDecimalPlaces(String decimalPlaces) {
	  this.match = this.getCalculatedQuestionVariableMin() + "|" + this.getCalculatedQuestionVariableMax() + "," + decimalPlaces;
 }
