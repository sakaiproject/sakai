...
public class PublishedAssessmentSettingsBean extends SpringBeanAutowiringSupport implements Serializable {
  ...
  @Setter @Getter private boolean gradebookGroupEnabled;
  ...
  public PublishedAssessmentSettingsBean() {
    ...
    try {
      ...
      if (evaluation != null) {
        ...
        this.gradebookGroupEnabled = populateGradebookGroupEnabled();
  ...
  public boolean populateGradebookGroupEnabled() {
    if (!this.gradebookGroupEnabled) {
