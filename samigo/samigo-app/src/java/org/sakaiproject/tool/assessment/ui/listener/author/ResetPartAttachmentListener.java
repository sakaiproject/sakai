    ...
    implements ActionListener
{
  ...
  public void processAction(ActionEvent ae) throws AbortProcessingException {
    ...
    if (resourceHash == null || resourceHash.isEmpty()) return;
    ...
    /* OK - the fact that resources belongs to other section get deleted is too great if there is a
