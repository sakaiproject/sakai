   ...
   <h3><h:outputText  value="#{authorImportExport.export_a} #{authorImportExport.dash} #{assessmentBean.title}" escape="false"/></h3>
    ...
    <br/>
     ...
     <h:commandButton value="#{authorImportExport.export}" type="submit"
       style="act" onclick="getSelectedType( '/samigo-app/jsf/qti/exportAssessment.xml?exportAssessmentId=#{assessmentBean.assessmentId}','/samigo-app/servlet/DownloadCP?&assessmentId=#{assessmentBean.assessmentId}'); return false;" />
