<!-- 2a ATTACHMENTS -->
 <div class="longtext"><h:outputLabel value="#{msg.attachments}" />
  <br/>
  <h:panelGroup rendered="#{assessmentBean.hasAttachment}">
    <h:dataTable value="#{assessmentBean.attachmentList}" var="attach">
      <h:column>
  ...
  <sakai:button_bar>
    <sakai:button_bar_item action="#{assessmentBean.addAttachmentsRedirect}"
