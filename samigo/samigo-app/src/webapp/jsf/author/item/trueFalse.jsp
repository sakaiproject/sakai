...
<p class="act">
 ...
 <h:commandButton rendered="#{itemauthor.target=='questionpool'}" value="#{commonMessages.cancel_action}" action="editPool" immediate="true">
    ...
    <!-- NEGATIVE POINT -->
    <div class="form-group row">
        <h:outputLabel for="answerdsc" value="#{authorMessages.negative_point_value}" styleClass="col-md-2 form-control-label"/>
        <div class="col-md-2">
    ...
    <!-- 3 ANSWER -->
    <div class="form-group row">
        <h:outputLabel for="TF" value="#{authorMessages.answer} " styleClass="col-md-2 form-control-label"/>
    ...
    <!-- 4 RATIONALE -->
    <div class="form-group row">
        <h:outputLabel for="rational" value="#{authorMessages.req_rationale}" styleClass="col-md-2 form-control-label"/>
