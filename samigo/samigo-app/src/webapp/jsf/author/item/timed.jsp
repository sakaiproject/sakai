            ...
            <ul class="ulTimed">
                ...
                <li>
                    ...
                    <h:panelGroup id="timeSection" styleClass="#{!itemauthor.currentItem.timedQuestion ? 'hidden' : ''}">
                        ...
                        <input type="number" min="0" max="11" onchange="this.reportValidity()? document.getElementById('itemForm:timed:hiddenTimedHours').value=this.value : false" value="<h:outputText value="#{itemauthor.currentItem.timedHours}" />"/>
                        ...
                        <input type="number" min="0" max="59" onchange="this.reportValidity()? document.getElementById('itemForm:timed:hiddenTimedMinutes').value=this.value : false" value="<h:outputText value="#{itemauthor.currentItem.timedMinutes}" />"/>
