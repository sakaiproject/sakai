...
<h:form id="itemForm">
<f:verbatim><input type="hidden" id="ckeditor-autosave-context" name="ckeditor-autosave-context" value="samigo_edit_fileUpload" /></f:verbatim>
...
<p class="act">
 ...
 <h:commandButton rendered="#{itemauthor.target=='questionpool'}" value="#{commonMessages.cancel_action}" action="editPool" immediate="true">
    ...
    <h:panelGroup styleClass="form-group row" layout="block" 
        ...
        <h:outputLabel for="questionFeedbackCorrect_textinput" value="#{commonMessages.feedback_optional}" styleClass="form-label"/>
        <!-- WYSIWYG -->
        <div class="col-md-8">
            <h:panelGrid>
                <samigo:wysiwyg identity="questionFeedbackCorrect" rows="140" value="#{itemauthor.currentItem.generalFeedback}" hasToggle="yes" mode="author">
                    <f:validateLength maximum="60000"/>
                </samigo:wysiwyg>
            </h:panelGrid>
        </div>
    ...
    <h:panelGroup rendered="#{itemauthor.showMetadata == 'true'}" styleClass="longtext">
        <div class="form-group row">
            <h:outputLabel for="questionFeedbackIncorrect" value="Metadata" styleClass="col-md-12 form-label"/>
        </div>
        <div class="form-group row">
