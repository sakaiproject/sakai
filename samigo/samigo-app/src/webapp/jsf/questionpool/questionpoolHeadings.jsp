...
<h:outputText value=" #{genMsg.separator} " rendered="#{authorization.adminAssessment}"/>
    ...
    <h:commandLink accesskey="#{genMsg.a_template}" title="#{genMsg.t_template}" action="template" immediate="true" rendered="#{authorization.adminQuestionPool}">
    ...
    <h:commandLink accesskey="#{genMsg.a_pool}" title=" #{genMsg.t_questionPool} " action="poolList" immediate="true">
