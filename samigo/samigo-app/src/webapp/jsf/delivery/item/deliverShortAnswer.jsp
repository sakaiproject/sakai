...
<f:verbatim><input type="hidden" id="ckeditor-autosave-context" value="samigo_deliverShortAnswer" /></f:verbatim>
<h:panelGroup rendered="#{question.itemData.itemId!=null}"><f:verbatim><input type="hidden" id="ckeditor-autosave-entity-id" value="</f:verbatim><h:outputText value="#{question.itemData.itemId}"/><f:verbatim>"/></f:verbatim></h:panelGroup>
