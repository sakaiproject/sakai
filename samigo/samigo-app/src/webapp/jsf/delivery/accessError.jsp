...
<div class="portletBody">
 ...
 <h:form id="removeTemplateForm">
   ...
   <f:verbatim><p class="act"></f:verbatim>
       <h:commandButton accesskey="#{deliveryMessages.a_cancel}" value="#{deliveryMessages.button_return}" type="submit"
  ...
  <h:commandButton accesskey="#{deliveryMessages.a_cancel}" value="#{deliveryMessages.button_return}" type="button" 
