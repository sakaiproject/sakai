...
<f:verbatim><div class="tier2"/></f:verbatim>
       ...
       <h:panelGrid columns="2" rendered="#{item.questionType == '3' or item.questionType == '13'}">
        ...
        <h:panelGrid columns="2" rendered="#{item.questionType == '1' or  item.questionType == '2' or  item.questionType == '4' or  item.questionType == '8' or item.questionType == '9' or item.questionType == '11' or item.questionType == '12' or item.questionType == '14'}" columnClasses="alignLeft,aligntRight"><!-- // CALCULATED_QUESTION -->
