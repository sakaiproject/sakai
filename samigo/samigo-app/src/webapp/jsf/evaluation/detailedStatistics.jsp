  ...
  <div class="b5 d-flex justify-content-between my-2">
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-right">
            <li>
                <h:outputLink value="#{histogramScores.exportItemAnalysisPdf}" title="#{evaluationMessages.export_as_pdf}" target="_blank">
                    <h:outputText value="#{evaluationMessages.export_pdf}" />
                </h:outputLink>
            </li>
            <li>
                <h:outputLink value="#{histogramScores.exportItemAnalysisXlsx}" title="#{evaluationMessages.export_as_xlsx}" target="_blank">
