...
public class AssessmentFeedbackDateRulesTest {

    @Test
    public void rejectsFeedbackDatesWithoutDueDate() {
        List<AssessmentFeedbackDateRules.Violation> violations = AssessmentFeedbackDateRules.validate(null, null, null,
                date("2026-06-25T00:00:00Z"), null);

        assertTrue(hasError(violations, AssessmentFeedbackDateRules.Error.MISSING_DUE_DATE));
    }

    @Test
    public void allowsMissingDueDateWhenNoFeedbackDatesAreSet() {
        List<AssessmentFeedbackDateRules.Violation> violations = AssessmentFeedbackDateRules.validate(null, null, null, null, null);

        assertFalse(hasError(violations, AssessmentFeedbackDateRules.Error.MISSING_DUE_DATE));
    }

    @Test
    public void rejectsFeedbackStartBeforeDueDate() {
        List<AssessmentFeedbackDateRules.Violation> violations = AssessmentFeedbackDateRules.validate(date("2026-06-25T00:00:00Z"), null, null,
                date("2026-06-24T23:59:59Z"), null);

        assertTrue(hasError(violations, AssessmentFeedbackDateRules.Error.FEEDBACK_START_BEFORE_DUE_DATE));
    }
    ...
    public void rejectsFeedbackEndBeforeStart() {
        ...
        assertTrue(hasError(violations, AssessmentFeedbackDateRules.Error.FEEDBACK_END_BEFORE_START));
    }

    @Test
    public void rejectsFeedbackEndBeforeLateSubmissionDate() {
        List<AssessmentFeedbackDateRules.Violation> violations = AssessmentFeedbackDateRules.validate(date("2026-06-25T00:00:00Z"),
                date("2026-06-26T00:00:00Z"), AssessmentAccessControlIfc.ACCEPT_LATE_SUBMISSION,
                date("2026-06-26T00:00:00Z"), date("2026-06-25T23:59:59Z"));

        assertTrue(hasError(violations, AssessmentFeedbackDateRules.Error.FEEDBACK_END_BEFORE_DUE_DATE));
    }
    ...
    public void allowsFeedbackDatesOnDueDate() {
        ...
        assertFalse(hasError(violations, AssessmentFeedbackDateRules.Error.FEEDBACK_START_BEFORE_DUE_DATE));
        assertFalse(hasError(violations, AssessmentFeedbackDateRules.Error.MISSING_DUE_DATE));
    }
    ...
    public void usesDueDateAsCutoffWhenRetractEqualsDueDate() {
        ...
        assertEquals(dueDate, AssessmentFeedbackDateRules.getFeedbackCutoffDate(dueDate, dueDate,
    ...
    public void usesDueDateAsCutoffWhenRetractIsBeforeDueDate() {
        ...
        assertEquals(dueDate, AssessmentFeedbackDateRules.getFeedbackCutoffDate(dueDate, date("2026-06-24T00:00:00Z"),
                AssessmentAccessControlIfc.ACCEPT_LATE_SUBMISSION));
    }
    ...
    public void importPolicyProducesDatesThatPassStrictValidation() {
        ...
        List<AssessmentFeedbackDateRules.Violation> violations = AssessmentFeedbackDateRules.validate(
    ...
    private boolean hasError(List<AssessmentFeedbackDateRules.Violation> violations, AssessmentFeedbackDateRules.Error error) {
