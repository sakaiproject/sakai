...
<!-- content... -->
<!-- preview an Item through an url -->
<h:form id="assesssmentForm">

<h:messages/>

<h:inputHidden id="setItemData" value="#{testwsbean.itemid}"/>
 ...
 <h:panelGrid columns="2" border="1" width="100%">
  ...
  <h:commandButton value="#{msg.button_back}"  onclick="window.close();" action="" type="reset"/>
