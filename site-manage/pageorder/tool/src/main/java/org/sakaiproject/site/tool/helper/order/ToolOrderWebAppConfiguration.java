...
public class ToolOrderWebAppConfiguration implements WebApplicationInitializer {

    @Override
    public void onStartup(ServletContext servletContext) throws ServletException {
        AnnotationConfigWebApplicationContext rootContext = new AnnotationConfigWebApplicationContext();
        rootContext.setServletContext(servletContext);
        rootContext.register(ToolOrderWebMvcConfiguration.class);
        ...
        Dynamic servlet = servletContext.addServlet("sakai-site-pageorder-helper", new DispatcherServlet(rootContext));
        servlet.addMapping("/");
