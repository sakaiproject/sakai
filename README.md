...
To build Sakai you need Java 1.8 and Maven 3.2. Once you have a clone of this repository you can
build it by running:
```
mvn install
```
...
You **must** also follow the instructions mentioned in the below link to setup mysql and other configurations(Step 9 is important).
...
[Sakai 11.3](https://confluence.sakaiproject.org/display/DOC/Sakai+11+Release+Notes) is the recommended version for production use.
...
## Under Development
Sakai 12 is under development and expected to branch in the first quarter of 2017.
