...
public class Constants {
     ...
     */
    public final static String METHOD_ID = "org.sakaiproject.pluto.core.method";


    /**
     * The unique method identifier for render requests.  Render requests are
     * requested through a call to the {@link PortletContainer#doRender(org.sakaiproject.pluto.PortletWindow,
    ...
    /**
     * The unique method identifier for render requests.  Render requests are
     * requested through a call to the {@link PortletContainer#doAction(org.sakaiproject.pluto.PortletWindow,
        * javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)}
     * method.
     */
     ...
     * requested through a call to the {@link PortletContainer#doLoad(org.sakaiproject.pluto.PortletWindow,
        * javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)}
     * method.
     */
