...
public class WebAppDescriptorServiceImplTest extends TestCase {
    ...
    public void setUp() {
        ...
        filters.append(""+
                ...
                "      <filter-class>org.sakaiproject.pluto.test.TestMe</filter-class>\n" +
        ...
        listeners.append("" +
                "  <listener>\n" +
                "      <listener-class>org.sakaiproject.pluto.test.TestListener</listener-class>\n" +
                "  </listener>\n" +
                "  <listener>\n" +
                "      <listener-class>org.sakaiproject.pluto.test.AnotherListener</listener-class>\n" +
                "  </listener>\n" );
        servlets.append(""+
                "  <servlet>\n" +
        ...
        this.ejbRef.append(""+
                ...
                "        <ejb-ref-type>org.sakaiproject.pluto.test.ejb.TestEJB</ejb-ref-type>\n" +
                "    </ejb-ref>\n" );
