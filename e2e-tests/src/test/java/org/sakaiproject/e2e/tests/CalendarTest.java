...
class CalendarTest extends SakaiUiTestBase {
    ...
    void canCreateEvent() {
        ...
        assertThat(eventRows().filter(new Locator.FilterOptions().setHasText(EVENT_TITLE))).hasCount(1,
            new LocatorAssertions.HasCountOptions().setTimeout(120_000));
    }
    ...
    private void switchToListView() {
        ...
        assertThat(viewSelect).isVisible(new LocatorAssertions.IsVisibleOptions().setTimeout(90_000));
        ...
        assertThat(timeFilter).isVisible(new LocatorAssertions.IsVisibleOptions().setTimeout(90_000));
        if (!"SHOW_ALL".equals(timeFilter.inputValue())) {
            ...
            assertThat(timeFilterAfterNav).isVisible(new LocatorAssertions.IsVisibleOptions().setTimeout(90_000));
