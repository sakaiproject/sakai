/**********************************************************************************
 * $URL: https://sakai21-dev.its.yale.edu/svn/signup/branches/2-5/tool/src/java/org/sakaiproject/signup/tool/jsf/organizer/action/CancelRestoreTimeslot.java $
 * $Id: CancelRestoreTimeslot.java 2975 2008-04-11 16:01:29Z gl256 $
***********************************************************************************
 *
...
public class CancelRestoreTimeslot extends SignupAction {
	...
	public SignupMeeting cancelOrRestore() throws Exception {
		...
		try {
			...
			logger.info("Meeting Name:" + meeting.getTitle() + " - UserId:" + userId + " - has "
