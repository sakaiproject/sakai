			...
			<h:form id="meeting">
				...
				<h:panelGrid columns="1">
						...
						<h:panelGrid columns="2"  columnClasses="titleColumn,valueColumn">
								...
								<h:outputText value="&nbsp;" escape="false" rendered="#{NewSignupMeetingBean.announcementType}"/>
								<h:panelGrid columns="1" rendered="#{NewSignupMeetingBean.announcementType}" styleClass="meetingTypeTable">
									<h:outputText value="#{msgs.event_open_session_no_signup_required}" />											
								</h:panelGrid>
				...
				<h:inputHidden value="step5" binding="#{NewSignupMeetingBean.currentStepHiddenInfo}"/>
				<sakai:button_bar>
