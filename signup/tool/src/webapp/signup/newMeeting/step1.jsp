		...
		<script>
	         ...
	         jQuery(document).ready(function() {
                ...
                localDatePicker({
                    ...
                    val: '<h:outputText value="#{NewSignupMeetingBean.signupMeeting.startTime}"><f:convertDateTime pattern="yyyy-MM-dd HH:mm:ss" timeZone="#{NewSignupMeetingBean.signupMeeting.timezone}" /></h:outputText>',
                    ashidden: {
                ...
                localDatePicker({
                    ...
                    parseFormat: 'YYYY-MM-DD HH:mm:ss',
                    allowEmptyDate: false,
                    val: '<h:outputText value="#{NewSignupMeetingBean.signupMeeting.endTime}"><f:convertDateTime pattern="yyyy-MM-dd HH:mm:ss" timeZone="#{NewSignupMeetingBean.signupMeeting.timezone}" /></h:outputText>',
                    ashidden: {
                ...
                localDatePicker({
                    ...
                    allowEmptyDate: false,
                    val: '<h:outputText value="#{NewSignupMeetingBean.repeatUntil}"><f:convertDateTime pattern="yyyy-MM-dd" timeZone="#{NewSignupMeetingBean.signupMeeting.timezone}" /></h:outputText>',
                    ashidden: {
