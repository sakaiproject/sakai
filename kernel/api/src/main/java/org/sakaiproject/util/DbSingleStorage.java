...
/**
 * Historical interface for the database-backed entity stores. Implementations now include the
 * XML-only store and the serialized-entity store, both of which expose the same operations for
 * locking, reading, and writing content rows.
 */
