...
public interface EntityProducer
{
	 ...
	 * @return A log of status messages from the merge.
	 */
	default String mergeWithCreatorId(String siteId, Element root, String archivePath, String fromSiteId, Map<String, String> attachmentNames, Map<String, String> userIdTrans,
			Set<String> userListAllowImport, String creatorId) {
