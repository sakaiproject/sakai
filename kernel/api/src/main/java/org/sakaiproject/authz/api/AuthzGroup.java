...
import org.sakaiproject.authz.api.exception.RoleAlreadyDefinedException;
 ...
 * </p>
 */
public interface AuthzGroup extends Entity, Comparable, Serializable
{
	/**
	 ...
	 */
	public List<Role> getRolesIsAllowed(String function);
	 ...
	 */
	public List<String> getUsersHasRole(String role);
	 ...
	 */
	public List<String> getUsersIsAllowed(String function);
