 ...
 */
public class BaseEmailMessage implements EmailMessage
{
	/**
	...
	public BaseEmailMessage(String from, String subject, String body)
	{
		setFrom(from);
		setSubject(subject);
		setBody(body);
	...
	{
		this.from = new BaseEmailAddress(email);
	}
	...
	public void addRecipient(RecipientType type, String email)
	{
		...
		addresses.add(new BaseEmailAddress(email));
	...
	public void addRecipient(RecipientType type, String name, String email)
	{
		...
		if (addresses == null)
			addresses = new ArrayList<EmailAddress>();
		addresses.add(new BaseEmailAddress(email, name));
		recipients.put(type, addresses);
	}
	...
	{
		addAttachment(new BaseAttachment(file));
	}
