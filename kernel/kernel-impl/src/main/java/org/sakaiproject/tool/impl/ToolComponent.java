...
public abstract class ToolComponent implements ToolManager
{
	...
	public boolean allowTool(Site site, Placement placement)
	{
		...
		try
		{
			...
			{
				boolean shoppingUiEnabled = (serverConfigurationService != null)
						&& serverConfigurationService.getBoolean(PROP_SHOPPING_UI_ENABLED, PROP_SHOPPING_UI_ENABLED_DEFAULT);
