...
INSERT INTO SAKAI_SITE VALUES('~admin', 'Admin Home', null, null, 'This is the home site of the admin user.  To administer this server go to the <a href="/portal/site/!admin" target="_top">Adminstration Workspace</a>.', null, null, null, 1, 0, 0, '', 'admin', 'admin', NOW(), NOW(), 0, 1, 0, 0, null);
