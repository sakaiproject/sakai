...
public class ActiveToolComponentTest {
	...
	public void setUp() {
		...
		activeToolComponent.setThreadLocalManager(threadLocalComponent);
		activeToolComponent.setSecurityService(securityService);
		activeToolComponent.setSiteService(siteService);
		activeToolComponent.setSessionManager(sessionManager);
		activeToolComponent.setFunctionManager(functionManager);
		activeToolComponent.setServerConfigurationService(serverConfigurationService);
