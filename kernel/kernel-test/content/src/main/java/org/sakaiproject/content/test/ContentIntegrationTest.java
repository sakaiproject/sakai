...
public class ContentIntegrationTest extends SakaiTestBase
{
	private static final Log log = LogFactory.getLog(ContentIntegrationTest.class);
	...
	{
		TestSetup setup = new TestSetup(new TestSuite(ContentIntegrationTest.class))
		{
