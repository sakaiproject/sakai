...
public class AlphaNumericComparatorTest {
    ...
    public void alphanumericCompare() {
        List<String> rawData = Arrays.asList("X19", "X10", "X25", "X111", "X2", "X1", "X", "0", null, "A11", "B12");
        List<String> expectedSort = Arrays.asList(null, "0", "A11", "B12", "X", "X1", "X2", "X10", "X19", "X25", "X111");
