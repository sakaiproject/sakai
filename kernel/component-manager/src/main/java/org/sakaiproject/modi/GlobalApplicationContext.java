 ...
 *
 * This is used by the {@link Launcher} to ensure that there is a root context available
 * to all of the components and webapps.
 *
 * It can also be used in integration tests to set up a shared context for classes that
 * use the {@link org.sakaiproject.component.api.ComponentManager} directly.
 */
public class GlobalApplicationContext {
     ...
     *
     * This will not typically be called during normal operation, except at shutdown.
     * However, there is no need to protect this instance. If someone is working to
     * refactor code to use injection directly, resetting the global context may be
     * useful for testing.
     */
