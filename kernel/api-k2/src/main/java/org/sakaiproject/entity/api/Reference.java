...
public interface Reference
{
	 ...
	 *        The list.
	 */
	void addSiteContextAuthzGroup(List<String> rv);
	 ...
	 *        The user id.
	 */
	void addUserAuthzGroup(List<String> rv, String id);
	 ...
	 *        The user id.
	 */
	void addUserTemplateAuthzGroup(List<String> rv, String id);
	 ...
	 * @return List of AuthzGroup ids (String) associated with this referenced resource.
	 */
	List<String> getAuthzGroups(String userId);
