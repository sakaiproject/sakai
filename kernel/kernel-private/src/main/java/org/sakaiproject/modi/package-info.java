 ...
 * ApplicationContext. With modi, there is a top-level context available globally and web applications can use it as
 * a parent by declaring the context-class.
 */
