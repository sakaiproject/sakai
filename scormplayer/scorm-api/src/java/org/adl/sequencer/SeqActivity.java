...
SeqActivityStateAccess, Serializable, ISeqActivity
{
   ...
   */
      ...
      if ( _Debug )
      {
         ...
         if ( mActivityAbDur_track != null )
         {
            System.out.println("\t  ::--> Act Ab Dur  : " + 
                               ...
                               format(IDuration.FORMAT_SECONDS));
         }
         else
         {
    ...
    */ 
   public void setChildren(Vector ioChildren, boolean iAll)
   {
    ...
    *         children.
    */
   public List getChildren(boolean iAll)
   {
