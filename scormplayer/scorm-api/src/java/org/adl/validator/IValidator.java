...
public interface IValidator extends Serializable {
	 ...
	 *         otherwise.
	 */
	public boolean validate(String iFileName, String iTestType,
			String iApplicationProfileType, boolean iManifestOnly);
	 ...
	 */
	public Vector getLaunchData(boolean iDefaultOrganizationOnly,
	 ...
	 */
	public Vector getLaunchData(Document iRolledUpDocument,
			boolean iDefaultOrganizationOnly, boolean iRemoveAssets);
