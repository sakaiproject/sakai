...
/**
 * This is the model for a user's profile privacy record, used by the PrivacyEntityProvider
 * 
...
public class PrivacyEntity {
	 ...
	 * @param myStatus
	 */
	public PrivacyEntity(String userUuid, int profileImage, int basicInfo, int contactInfo, int academicInfo, int personalInfo, boolean showBirthYear, int search, int myFriends, int myStatus) {
		super();
