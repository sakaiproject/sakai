...
public class MySocialNetworkingEdit extends Panel {
	...
	public MySocialNetworkingEdit(final String id, final UserProfile userProfile) {
		...
		facebookContainer.add(new IconWithToolTip("facebookToolTip", "info-circle", new ResourceModel("text.profile.facebook.tooltip")));
		...
		linkedinContainer.add(new IconWithToolTip("linkedinToolTip", "info-circle", new ResourceModel("text.profile.linkedin.tooltip")));
		...
		myspaceContainer.add(new IconWithToolTip("myspaceToolTip", "info-circle", new ResourceModel("text.profile.myspace.tooltip")));
		...
		twitterContainer.add(new IconWithToolTip("twitterToolTip", "info-circle", new ResourceModel("text.profile.twitter.tooltip")));
