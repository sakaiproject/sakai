...
public interface StatsUpdateManager {
	...
	/** Get the time that occurred last rest (or StatsUpdateManager initialization) */
	public long getResetTime();
	
	/** Get the total time ellapsed, in milliseconds, since start */
	public long getTotalTimeEllapsedSinceReset();
	
	/** Get the average number of events processed by second */
	public double getNumberOfEventsProcessedPerSec();
	
	/** Get the average number of events generated by Sakai by second */
