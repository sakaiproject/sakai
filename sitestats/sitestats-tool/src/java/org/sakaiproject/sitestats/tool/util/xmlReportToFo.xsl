<xsl:stylesheet version="1.1"
			...
			<fo:page-sequence master-reference="simpleA4">
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:block font-size="10pt" border-color="#cccccc" border-width="0.75pt" border-style="dashed" >
						...
						<fo:table table-layout="fixed" width="100%" border-collapse="collapse" padding-top="5pt" padding-bottom="5pt">
	...
	<xsl:template match="datarowheader">
		<fo:table-row text-decoration="underline" color="blue">
			<!-- border-bottom-width="0.75pt" border-bottom-style="dashed" border-bottom-color="black" -->
