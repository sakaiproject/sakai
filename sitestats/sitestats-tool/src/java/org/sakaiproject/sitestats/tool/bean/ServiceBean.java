...
public class ServiceBean {
	...
	public void setSstEventRegistryService(EventRegistryService sstEventRegistryService) {
		this.SST_ers = sstEventRegistryService;
	}
	public EventRegistryService getSstEventRegistryService() {
		return SST_ers;
	}
