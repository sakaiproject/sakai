...
/**
* Sunday, Tuesday, Thursday recurrence rule
*/
public class STTRecurrenceRule extends RecurrenceRuleBase
{
	...
	public STTRecurrenceRule(int interval) {
		super(interval);
		calUtil = new CalendarUtil();
	}	

	
	public STTRecurrenceRule(int interval, int count) {
		super(interval, count);
		calUtil = new CalendarUtil();
	}	
	
	public STTRecurrenceRule(int interval, Time until) {
	...
	public Element toXml(Document doc, Stack stack) {
		...
		rule.setAttribute("class", "org.chefproject.osid.calendar.STTRecurrenceRule");
		rule.setAttribute("name", "STTRecurrenceRule");
	...
	public String getFrequencyDescription() {
		return rb.getFormattedMessage("set.STT.fm", calUtil.getDayOfWeekName(0), calUtil.getDayOfWeekName(2), calUtil.getDayOfWeekName(4));
	}
	...
	*/
	public List generateInstances(TimeRange prototype, TimeRange range, TimeZone timeZone)
	{
		...
		//if day of week is not Sunday, Tuesday or Thursday
		...
		{	
			...
			// Examine every day in the calendar, if next date is not Sunday or Tuesday or Thursday
			do{				
				...
				//for example if this is a friday and interval is two weeks, we skip to saturday of next week then continue.
