...
/**
* Sunday, Monday, Tuesday, Wednesday recurrence rule
*/
public class SMTWRecurrenceRule extends RecurrenceRuleBase
{
	...
	public SMTWRecurrenceRule(int interval) {
		super(interval);
		calUtil = new CalendarUtil();
	}	

	
	public SMTWRecurrenceRule(int interval, int count) {
		super(interval, count);
		calUtil = new CalendarUtil();
	}	
	
	public SMTWRecurrenceRule(int interval, Time until) {
	...
	public Element toXml(Document doc, Stack stack) {
		...
		rule.setAttribute("class", "org.chefproject.osid.calendar.SMTWRecurrenceRule");
		rule.setAttribute("name", "SMTWRecurrenceRule");
	...
	public String getFrequencyDescription() {
		return rb.getFormattedMessage("set.SMTW.fm", calUtil.getDayOfWeekName(0), calUtil.getDayOfWeekName(1), calUtil.getDayOfWeekName(2), calUtil.getDayOfWeekName(3));
	}
	...
	*/
	public List generateInstances(TimeRange prototype, TimeRange range, TimeZone timeZone)
	{
		...
		//if day of week is not Sunday, Monday,Tuesday or Wednesday
		...
		{	
			...
			// Examine every day in the calendar, if next date is not Sunday or Monday or Tuesday or Wednesday
			do{				
