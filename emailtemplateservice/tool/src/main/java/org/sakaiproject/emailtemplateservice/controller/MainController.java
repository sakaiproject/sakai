...
public class MainController {
    ...
    public @ResponseBody
    ResponseEntity<String> UpdateEmail(HttpServletRequest req, Model model, @PathVariable(value = "id", required = false) Long id, @RequestBody String requestString, HttpServletResponse response) {
        ...
        try {
            ...
            List<String> errors = getErrors(emailTemplate, model, req, response);
            if (errors.isEmpty()) {
    ...
    public List getErrors(EmailTemplate emailTemplate, Model model, HttpServletRequest request, HttpServletResponse response) {
