...
public interface LTIService extends LTISubstitutionsFilter {
    ...
    String[] TOOL_MODEL = {
            ...
            "lti13:radio:hidden=true:label=bl_lti13:role=admin",
            "lti13_settings:text:hidden=true:maxlength=1M:role=admin",
            "lti13_tool_header:header:label=bl_lti13_tool_header:fields=lti13_client_id,lti13_keyset_url, lti13_provider_private",
            "lti13_client_id:text:label=bl_lti13_client_id:maxlength=1024:role=admin",
            "lti13_keyset_url:url:label=bl_lti13_keyset_url:maxlength=1024:role=admin",
            "lti13_provider_private:textarea:label=bl_lti13_provider_private:maxlength=1M:role=admin",  // This will stay null
            "lti13_platform_header:header:label=bl_lti13_platform_header:fields=lti13_provider_public,lti13_consumer_public,lti13_consumer_private",
            "lti13_provider_public:textarea:label=bl_lti13_provider_public:maxlength=1M:role=admin",
            "lti13_consumer_public:textarea:label=bl_lti13_consumer_public:maxlength=1M:role=admin",
            "lti13_consumer_private:textarea:label=bl_lti13_consumer_private:maxlength=1M:role=admin",
