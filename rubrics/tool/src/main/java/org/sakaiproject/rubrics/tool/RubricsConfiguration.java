...
public class RubricsConfiguration implements WebApplicationInitializer {
    ...
    public void onStartup(ServletContext servletContext) throws ServletException {
        ...
        ServletRegistration.Dynamic servlet = servletContext.addServlet("sakai.rubrics", new DispatcherServlet(rootContext));
        servlet.addMapping("/");
