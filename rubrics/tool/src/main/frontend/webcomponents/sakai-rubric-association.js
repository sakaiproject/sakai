...
class SakaiRubricAssociation extends SakaiElement {
  ...
  static get properties() {
    ...
    return {
      ...
      //configurationOptions: { type: Array },
      dontAssociateLabel: { type: String },
      associateLabel: { type: String },
      dontAssociateValue: { type: Number },
      associateValue: { type: Number },
      fineTunePoints: String,
      hideStudentPreview: String,
      rubrics: { type: Array },
    };
  }
