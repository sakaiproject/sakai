...
export class SakaiRubricCriterionEdit extends SakaiElement {
  ...
  render() {
    ...
    return html`
      <span tabindex="0" role="button" class="edit fa fa-edit" @click="${this.editCriterion}" title="${tr("edit_criterion")} ${this.criterion.title}"></span>
