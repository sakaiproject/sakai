...
create table CM_ACADEMIC_SESSION_T (ACADEMIC_SESSION_ID bigint generated by default as identity (start with 1), VERSION integer not null, LAST_MODIFIED_BY varchar(255), LAST_MODIFIED_DATE timestamp, CREATED_BY varchar(255), CREATED_DATE timestamp, ENTERPRISE_ID varchar(255) not null, TITLE varchar(255) not null, DESCRIPTION varchar(255) not null, START_DATE timestamp, END_DATE timestamp, primary key (ACADEMIC_SESSION_ID), unique (ENTERPRISE_ID));
...
create table CM_CROSS_LISTING_T (CROSS_LISTING_ID bigint generated by default as identity (start with 1), VERSION integer not null, LAST_MODIFIED_BY varchar(255), LAST_MODIFIED_DATE timestamp, CREATED_BY varchar(255), CREATED_DATE timestamp, primary key (CROSS_LISTING_ID));
create table CM_ENROLLMENT_SET_T (ENROLLMENT_SET_ID bigint generated by default as identity (start with 1), VERSION integer not null, LAST_MODIFIED_BY varchar(255), LAST_MODIFIED_DATE timestamp, CREATED_BY varchar(255), CREATED_DATE timestamp, ENTERPRISE_ID varchar(255) not null, TITLE varchar(255) not null, DESCRIPTION varchar(255) not null, CATEGORY varchar(255) not null, DEFAULT_CREDITS varchar(255) not null, COURSE_OFFERING bigint, primary key (ENROLLMENT_SET_ID), unique (ENTERPRISE_ID));
create table CM_ENROLLMENT_T (ENROLLMENT_ID bigint generated by default as identity (start with 1), VERSION integer not null, LAST_MODIFIED_BY varchar(255), LAST_MODIFIED_DATE timestamp, CREATED_BY varchar(255), CREATED_DATE timestamp, USER_ID varchar(255) not null, STATUS varchar(255) not null, CREDITS varchar(255) not null, GRADING_SCHEME varchar(255) not null, DROPPED bit, ENROLLMENT_SET bigint, primary key (ENROLLMENT_ID));
create table CM_MEETING_T (MEETING_ID bigint generated by default as identity (start with 1), LOCATION varchar(255), TIME_OF_DAY varchar(255), NOTES varchar(255), SECTION_ID bigint not null, primary key (MEETING_ID));
create table CM_MEMBERSHIP_T (MEMBER_ID bigint generated by default as identity (start with 1), VERSION integer not null, USER_ID varchar(255) not null, ROLE varchar(255) not null, MEMBER_CONTAINER_ID bigint, primary key (MEMBER_ID));
create table CM_MEMBER_CONTAINER_T (MEMBER_CONTAINER_ID bigint generated by default as identity (start with 1), CLASS_DISCR varchar(100) not null, VERSION integer not null, LAST_MODIFIED_BY varchar(255), LAST_MODIFIED_DATE timestamp, CREATED_BY varchar(255), CREATED_DATE timestamp, ENTERPRISE_ID varchar(100) not null, TITLE varchar(255) not null, DESCRIPTION varchar(255) not null, CATEGORY varchar(255), COURSE_OFFERING bigint, ENROLLMENT_SET bigint, PARENT_SECTION bigint, STATUS varchar(255), CROSS_LISTING bigint, START_DATE timestamp, END_DATE timestamp, CANONICAL_COURSE bigint, ACADEMIC_SESSION bigint, PARENT_COURSE_SET bigint, EQUIV_CANON_COURSE_ID bigint, EQUIV_COURSE_OFFERING_ID bigint, primary key (MEMBER_CONTAINER_ID), unique (CLASS_DISCR, ENTERPRISE_ID));
