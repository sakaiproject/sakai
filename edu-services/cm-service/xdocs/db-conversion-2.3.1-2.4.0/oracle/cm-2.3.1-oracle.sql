...
create table CM_COURSE_SET_OFFERING_ASSOC_T (COURSE_OFFERING number(19,0) not null, COURSE_SET number(19,0) not null, primary key (COURSE_SET, COURSE_OFFERING));
