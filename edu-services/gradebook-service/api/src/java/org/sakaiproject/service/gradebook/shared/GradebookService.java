...
public interface GradebookService extends EntityProducer {
	 ...
	 */
	public Assignment getAssignment(String gradebookUid, String siteId, Long assignmentId)
			throws AssessmentNotFoundException;
	 ...
	 */
	public List<Assignment> getViewableAssignmentsForCurrentUser(String gradebookUid, String siteId);
	 ...
	 */
	public String getLowestPossibleGradeForGbItem(final String gradebookUid, final String siteId, final Long assignmentId);
	 ...
	 * @return
	 */
	public void updateAssignmentOrder(final String gradebookUid, final String siteId, final Long assignmentId, final Integer order);
	 ...
	 */
	CourseGrade getCourseGradeForStudent(String gradebookUid, String siteId, String userUuid);
	 ...
	 */
	Map<String, CourseGrade> getCourseGradeForStudents(String gradebookUid, String siteId, List<String> userUuids);
	 ...
	 * @return a Map of {@link CourseGrade} for the students. Key is the student uuid.
	 */
	Map<String, CourseGrade> getCourseGradeForStudents(String gradebookUid, String siteId, List<String> userUuids, Map<String, Double> schema);
	 ...
	 */
	@SuppressWarnings("rawtypes")
	List getViewableSections(String gradebookUid, String siteId);
	 ...
	 */
	void updateAssignmentCategorizedOrder(final String gradebookUid, final String siteId, final Long categoryId, final Long assignmentId, Integer order);
