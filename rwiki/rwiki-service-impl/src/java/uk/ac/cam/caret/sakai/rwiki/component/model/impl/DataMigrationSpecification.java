...
public class DataMigrationSpecification implements DataMigrationController {
	...
	public void update() throws Exception {
		...
		RWikiProperty currentVersion = propertyDao.getProperty(targetVersion.getName());
		...
		if ( currentVersionString != null && currentVersionString.equals(targetVersionString) ) {
			...
			for ( Iterator i = migrationAgents.iterator(); i.hasNext(); ) {
				...
				currentVersionString = a.migrate(currentVersionString,targetVersionString);
			}
		}
		if ( currentVersion == null ) {
		...
		if ( currentVersionString != null && currentVersionString.equals(targetVersionString) ) {
			log.info("RWiki Data migrated to version "+currentVersionString+" sucessfuly");
		} else {
	...
	/**
	 * @param migrationAgents The migrationAgents to set.
	 */
