...
{
	private static final String RESOURCE_BUNDLE = "_uk.ac.cam.caret.sakai.rwiki.tool.bundle.Messages_";
	...
	{
		throw new UnsupportedOperationException("Cannot determine contents");
	}
	/* (non-Javadoc)
	...
	public Set entrySet()
	{
		throw new UnsupportedOperationException("No Entry Sey Avalable");
	}
	/* (non-Javadoc)
	...
	public Set keySet()
	{
		throw new UnsupportedOperationException("No Key Set Avalable");
	}
	/* (non-Javadoc)
	...
	{
		throw new UnsupportedOperationException("Value collection is not avaialble");
	}
	/**
	 * @param string
	 * @param string2
