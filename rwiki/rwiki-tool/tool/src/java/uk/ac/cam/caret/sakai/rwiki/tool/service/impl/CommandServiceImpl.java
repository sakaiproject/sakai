...
/**
 * Implementation of RWikiCommandService, that is initialised with a map of commands and a default command
 * 
 * @author andrew
 */
//FIXME: Tool
public class CommandServiceImpl implements CommandService {
    ...
    private class DefaultCommand implements HttpCommand {
        ...
        public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            String actionPath =  MessageFormat.format(template, new Object[] {action} );
            ...
            try {
                ...
                rd.forward(request, response);
        			...
        			if ( (start2 - start) > 20 ) {
        				...
        				log.warn("Defult Command Service Dispatch Preamble taking too long, " +
        						"Message Format "+i1+
        						" ms, getRequestDispatch "+i2+
        						" ms, forward "+i3+
        						" ms, overall "+i4+" ms");
        			}
            }
