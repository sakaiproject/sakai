...
<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page" xmlns:c="http://java.sun.com/jsp/jstl/core" version="2.0">
  ...
  <c:if test="${permissionsBeanRight.updateAllowed}">
    <span class="instruction" ><jsp:element name="a"><jsp:attribute name="href"><c:out value="${rightRenderBean.editUrl}"/></jsp:attribute>Edit: <c:out value="${rightRenderBean.localisedPageName}"/></jsp:element></span> 
  </c:if>
