 ...
 * 
 * Line endings for the left and right content are both normalized to Unix Line
 * endings by the simple regular expression replace "\r\n?" with "\n"
 * 
 * @version $Id$
 * @author andrew
 */
...
public class GenericDiffBean {
    ...
    public class ColorDiffTableRevisionVisitor implements RevisionVisitor {
        ...
        private void doRow(final int left, final int right,
            ...
            while (leftLineNum < left || rightLineNum < right) {
                ...
                if (leftLineNum < left) {
                    sb.append(
                            XmlEscaper.xmlEscape(
                                    (String) objectifiedLeft[leftLineNum++]));
                } else {
                    sb.append("&#160;");
                }
                ...
                if (rightLineNum < right) {
                    sb.append(
                            XmlEscaper.xmlEscape(
                                    (String) objectifiedRight[rightLineNum++]));
                } else {
                    sb.append("&#160;");
                }
                sb.append("</td></tr>");
        ...
        /**
         * Called once we have been visited by the revision and it's deltas.
         * 
         * The visitor methods will have been used to generate rows for an XHTML
    ...
    public class ColorDiffRevisionVisitor implements RevisionVisitor {
         ...
         * Called once we have been visited by the revision and it's deltas.
         * 
         * The visitor methods will have been used to generate an XHTML
     ...
     * 
     * This table is created using <code>ColorDiffTableRevisionVisitor</code>
     * 
     ...
     * the left and right revision contents.
     * 
     * This method uses the <code>ColorDiffRevisionVisitor</code>
     * 
