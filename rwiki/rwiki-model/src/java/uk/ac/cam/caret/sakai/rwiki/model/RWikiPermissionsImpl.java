...
public class RWikiPermissionsImpl implements RWikiPermissions {
        public static final int OWNER_READ_INDEX, OWNER_WRITE_INDEX, OWNER_ADMIN_INDEX;

        public static final int GROUP_READ_INDEX, GROUP_WRITE_INDEX, GROUP_ADMIN_INDEX;
...
/* TODO: remove                
        public static RWikiPermissions getRWikiPermissions(RWikiObject rwo) {
            RWikiPermissions permissions = new RWikiPermissionsImpl();
            permissions.setOwnerRead(rwo.getOwnerRead());
            ...
            permissions.setPublicWrite(rwo.getPublicWrite());
            return permissions;
        }
        */
