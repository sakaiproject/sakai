...
public class GradingAuthzImpl implements GradingAuthz {
    ...
    public boolean isUserAbleToGradeItemForStudent(String gradebookUid, String siteId, Long itemId, String studentUid) throws IllegalArgumentException {
        ...
        return isUserAbleToGradeOrViewItemForStudent(gradebookUid, siteId, itemId, studentUid, GradingService.gradePermission);
    }
    ...
    public boolean isUserAbleToViewItemForStudent(String gradebookUid, String siteId, Long itemId, String studentUid) throws IllegalArgumentException {
        ...
        return isUserAbleToGradeOrViewItemForStudent(gradebookUid, siteId, itemId, studentUid, GradingService.viewPermission);
    }
    ...
    public Map<EnrollmentRecord, String> findMatchingEnrollmentsForItem(String gradebookUid, String siteId, Long categoryId, GradingCategoryType gbCategoryType, String optionalSearchString, String optionalSectionUid) {
    ...
    public Map<EnrollmentRecord, String> findMatchingEnrollmentsForItemForUser(String userUid, String gradebookUid, String siteId, Long categoryId, GradingCategoryType gbCategoryType, String optionalSearchString, String optionalSectionUid) {

        return findMatchingEnrollmentsForItemOrCourseGrade(userUid, gradebookUid, siteId, categoryId, gbCategoryType, optionalSearchString, optionalSectionUid, false);
    }

    public Map<EnrollmentRecord, String> findMatchingEnrollmentsForViewableCourseGrade(String gradebookUid, String siteId, GradingCategoryType gbCategoryType, String optionalSearchString, String optionalSectionUid) {
     ...
     */
    private Map<EnrollmentRecord, String> findMatchingEnrollmentsForItemOrCourseGrade(String userUid, String gradebookUid, String siteId, Long categoryId, GradingCategoryType gbCategoryType, String optionalSearchString, String optionalSectionUid, boolean itemIsCourseGrade) {
