...
public class GbGradeTable extends Panel implements IHeaderContributor {
	...
	public void renderHead(final IHeaderResponse response) {
		...
		response.render(
				JavaScriptHeaderItem.forUrl(String.format("/gradebookng-tool/webjars/handsontable/6.0.0/handsontable.full.min.js?version=%s", version)));

		response.render(CssHeaderItem.forUrl(String.format("/gradebookng-tool/webjars/handsontable/6.0.0/handsontable.full.min.css?version=%s", version)));
