...
public class GbGradeTable extends Panel implements IHeaderContributor {
	...
	public void renderHead(final IHeaderResponse response) {
		...
		response.render(
				JavaScriptHeaderItem.forUrl(String.format("/gradebookng-tool/webjars/tabulator-tables/dist/js/tabulator.min.js%s", version)));
		response.render(CssHeaderItem.forUrl(String.format("/gradebookng-tool/webjars/tabulator-tables/dist/css/tabulator.min.css%s", version)));
