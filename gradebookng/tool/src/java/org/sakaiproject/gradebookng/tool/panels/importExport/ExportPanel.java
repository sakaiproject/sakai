	...
	public void onInitialize() {
		...
		add(new AjaxCheckBox("includePoints", Model.of(this.includePoints)) {
			...
			public boolean isVisible() {
				...
				final GradingCategoryType categoryType = ExportPanel.this.businessService.getGradebookCategoryType(currentGradebookUid, currentSiteId);
				...
				if (assignments.isEmpty()) {
					...
					for (int i = 0; i < assignments.size(); i++) {
						...
						if (isCustomExport && this.includeCategoryAverages
							...
							if (cd != null && this.businessService.getGradebookCategoryType(currentGradebookUid, currentSiteId) == GradingCategoryType.WEIGHTED_CATEGORY) {
