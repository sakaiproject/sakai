...
public interface AssignmentGradeRecordRepository extends SpringCrudRepository<AssignmentGradeRecord, Long> {
    ...
    List<AssignmentGradeRecord> findByGradableObject_Gradebook_IdAndGradableObject_RemovedOrderByPointsEarned(String gradebookId, Boolean removed);
    ...
    List<AssignmentGradeRecord> findByGradableObject_GradebookId(String gradebookId);
    ...
    List<AssignmentGradeRecord> findByGradableObject_Gradebook_IdAndGradableObject_RemovedAndStudentIdIn(String gradebookId, Boolean removed, Collection<String> studentIds);
