...
public interface CommentRepository extends SpringCrudRepository<Comment, Long> {
    ...
    Optional<Comment> findByStudentIdAndGradableObject_GradebookIdAndGradableObjectIdAndGradableObject_Removed(
    ...
    List<Comment> findByGradableObjectGradebookId(String gradebookId);
