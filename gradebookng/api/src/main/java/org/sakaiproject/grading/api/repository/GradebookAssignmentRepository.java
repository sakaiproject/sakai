...
public interface GradebookAssignmentRepository extends SpringCrudRepository<GradebookAssignment, Long> {
    ...
    List<GradebookAssignment> findByGradebook_IdAndRemovedAndDisplayInGradebookAndNotCounted(Long gradebookId, Boolean removed, Boolean displayInGradebook, Boolean notCounted);
    ...
    boolean existsByIdAndExternallyMaintained(Long id, Boolean externallyMaintained);
